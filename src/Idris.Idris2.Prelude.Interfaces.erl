...
-export([
  'case--guard-1021'/2,
  'nested--2196-1564--in--un--monoid'/1,
...
'nested--2196-1564--in--un--monoid'(V0) -> {'Idris.Prelude.Interfaces.MkMonoid', fun (V1) -> fun (V2) -> case V1 of 1 -> V2; 0 -> 0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end, 1}.
