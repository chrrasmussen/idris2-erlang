...
-export([
  'case--raiseToMaybe-521'/4,
  'dn--un--uninhabited_Uninhabited_(IsJust Nothing)'/3,
...
'case--raiseToMaybe-521'(V0, V1, V2, V3) -> case V3 of 0 -> {'Idris.Prelude.Types.Nothing'}; 1 -> {'Idris.Prelude.Types.Just', V2}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--uninhabited_Uninhabited_(IsJust Nothing)'(V0, V1, V2) -> ('erlang':'throw'("No clauses")).
'dn--un--__Impl_Uninhabited_(IsJust Nothing)'(V0, V1) -> ('dn--un--uninhabited_Uninhabited_(IsJust Nothing)'('erased', 'erased', V1)).
