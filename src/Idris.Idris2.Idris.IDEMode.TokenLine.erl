...
'case--tokens-431'(V0, V1) -> case V1 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V6, V7) -> ('Idris.Idris2.Prelude.Types.List':'un--++'(('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_List'(fun (V8) -> case V8 of {'Idris.Libraries.Text.Bounded.MkBounded', E6, E7, E8} -> (fun (V9, V10, V11) -> V9 end(E6, E7, E8)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end, V2)), case ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_String'(V7, <<""/utf8>>)) of 1 -> []; 0 -> [{'Idris.Idris.IDEMode.TokenLine.Other', V7} | []]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end)) end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'un--tokens'(V0) -> ('case--tokens-431'(V0, ('Idris.Idris2.Libraries.Text.Lexer.Core':'un--lex'(('un--srcTokens'()), V0)))).
