...
-export([
  'with--with block in splitRec-2768'/4,
  'with--splitRec-2760'/3,
  'case--splitHelp-2662'/8,
  'un--splitRec'/2,
  'un--splitHelp'/4,
  'un--split'/2,
  'un--snocListHelp'/4,
...
'with--with block in splitRec-2768'(V0, V1, V2, V3) -> case V1 of [] -> case V2 of {'Idris.Data.List.Views.SplitNil'} -> (fun () -> {'Idris.Data.List.Views.SplitRecNil'} end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end; [E0 | E1] -> (fun (V4, V5) -> case V5 of [] -> case V2 of {'Idris.Data.List.Views.SplitOne', E10} -> (fun (V6) -> {'Idris.Data.List.Views.SplitRecOne', V4} end(E10)); _ -> case V2 of {'Idris.Data.List.Views.SplitPair', E6, E7, E8, E9} -> (fun (V7, V8, V9, V10) -> {'Idris.Data.List.Views.SplitRecPair', [V4 | V8], [V9 | V10], fun () -> ('with--splitRec-2760'('erased', [V4 | V8], ((V3([V4 | V8]))(('un--smallerLeft'('erased', V8, V9, V10)))))) end, fun () -> ('with--splitRec-2760'('erased', [V9 | V10], ((V3([V9 | V10]))(('un--smallerRight'('erased', 'erased', V8, V10)))))) end} end(E6, E7, E8, E9)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end; _ -> case V2 of {'Idris.Data.List.Views.SplitPair', E2, E3, E4, E5} -> (fun (V11, V12, V13, V14) -> {'Idris.Data.List.Views.SplitRecPair', [V4 | V12], [V13 | V14], fun () -> ('with--splitRec-2760'('erased', [V4 | V12], ((V3([V4 | V12]))(('un--smallerLeft'('erased', V12, V13, V14)))))) end, fun () -> ('with--splitRec-2760'('erased', [V13 | V14], ((V3([V13 | V14]))(('un--smallerRight'('erased', 'erased', V12, V14)))))) end} end(E2, E3, E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--splitRec-2760'(V0, V1, V2) -> ('with--with block in splitRec-2768'('erased', V1, ('un--split'('erased', V1)), V2)).
'case--splitHelp-2662'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V5 of [] -> case V7 of {'Idris.Data.List.Views.SplitOne', E8} -> (fun (V8) -> {'Idris.Data.List.Views.SplitPair', V3, [], V4, []} end(E8)); _ -> case V7 of {'Idris.Data.List.Views.SplitPair', E4, E5, E6, E7} -> (fun (V9, V10, V11, V12) -> {'Idris.Data.List.Views.SplitPair', V3, [V4 | V10], V11, V12} end(E4, E5, E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end; _ -> case V7 of {'Idris.Data.List.Views.SplitPair', E0, E1, E2, E3} -> (fun (V13, V14, V15, V16) -> {'Idris.Data.List.Views.SplitPair', V3, [V4 | V14], V15, V16} end(E0, E1, E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end.
'un--splitRec'(V0, V1) -> ('with--splitRec-2760'('erased', V1, fun (V2) -> fun (V3) -> ('Idris.Idris2.Control.WellFounded':'un--sizeAccessible'('erased', fun (V4) -> ('Idris.Idris2.Control.WellFounded':'dn--un--size_Sized_(List $a)'('erased', V4)) end, V1, V2, V3)) end end)).
'un--splitHelp'(V0, V1, V2, V3) -> case V2 of [] -> {'Idris.Data.List.Views.SplitOne', V1}; [E0 | E1] -> (fun (V4, V5) -> case V3 of [] -> {'Idris.Data.List.Views.SplitPair', V1, [], V4, V5}; [E2 | E3] -> (fun (V6, V7) -> case V7 of [] -> {'Idris.Data.List.Views.SplitPair', V1, [], V4, V5}; [E4 | E5] -> (fun (V8, V9) -> ('case--splitHelp-2662'('erased', V8, V6, V1, V4, V5, V9, ('un--splitHelp'('erased', V1, V5, V9)))) end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
