...
-export([
  'with--with block in decEq-1335'/8,
  'with--decEq-1289'/7,
  'with--with block in decEq-1214'/6,
  'with--decEq-1164'/7,
  'with--with block in decEq-1034'/7,
  'with--decEq-975'/8,
  'with--decEq-853'/6,
  'with--decEq-752'/6,
  'with--decEq-682'/5,
  ...
  'case--decEq-1508'/3,
  'case--decEq-1437'/3,
  'nested--3833-1611--in--un--primitiveNotEq'/3,
  'nested--3756-1540--in--un--primitiveNotEq'/3,
  'nested--3679-1469--in--un--primitiveNotEq'/3,
  'nested--3602-1398--in--un--primitiveNotEq'/3,
  'nested--3833-1610--in--un--primitiveEq'/2,
  'nested--3756-1539--in--un--primitiveEq'/2,
  'nested--3679-1468--in--un--primitiveEq'/2,
  'nested--3602-1397--in--un--primitiveEq'/2,
...
'with--with block in decEq-1335'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V4 of {'Idris.Prelude.Types.No', E0} -> (fun (V8) -> {'Idris.Prelude.Types.No', fun (V9) -> (V8(('Idris.Idris2.Builtin':'un--snd'(('Idris.Idris2.Data.List1':'un--consInjective'(V9)))))) end} end(E0)); {'Idris.Prelude.Types.Yes', E1} -> (fun (V10) -> {'Idris.Prelude.Types.Yes', ('Idris.Idris2.Prelude.Basics':'un--cong2'(V7, V10))} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--decEq-1289'(V0, V1, V2, V3, V4, V5, V6) -> case V4 of {'Idris.Prelude.Types.No', E0} -> (fun (V7) -> {'Idris.Prelude.Types.No', fun (V8) -> (V7(('Idris.Idris2.Builtin':'un--fst'(('Idris.Idris2.Data.List1':'un--consInjective'(V8)))))) end} end(E0)); {'Idris.Prelude.Types.Yes', E1} -> (fun (V9) -> ('with--with block in decEq-1335'('erased', V1, V6, V5, ('dn--un--decEq_DecEq_(List $a)'(V1, V5, V6)), V2, V3, V9)) end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--with block in decEq-1214'(V0, V1, V2, V3, V4, V5) -> case V4 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V6) -> case V6 of 0 -> {'Idris.Prelude.Types.Yes', 0}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V7) -> {'Idris.Prelude.Types.No', fun (V8) -> (V7(('Idris.Idris2.Builtin':'un--snd'(('Idris.Idris2.Data.List':'un--consInjective'(V8)))))) end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--decEq-1164'(V0, V1, V2, V3, V4, V5, V6) -> case V4 of {'Idris.Prelude.Types.No', E0} -> (fun (V7) -> {'Idris.Prelude.Types.No', fun (V8) -> (V7(('Idris.Idris2.Builtin':'un--fst'(('Idris.Idris2.Data.List':'un--consInjective'(V8)))))) end} end(E0)); {'Idris.Prelude.Types.Yes', E1} -> (fun (V9) -> case V9 of 0 -> ('with--with block in decEq-1214'('erased', V1, V6, V5, ('dn--un--decEq_DecEq_(List $a)'(V1, V5, V6)), V2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--with block in decEq-1034'(V0, V1, V2, V3, V4, V5, V6) -> case V5 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V7) -> case V7 of 0 -> {'Idris.Prelude.Types.Yes', 0}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V8) -> {'Idris.Prelude.Types.No', fun (V9) -> (V8(('Idris.Idris2.Builtin':'un--snd'(('un--pairInjective'(V9)))))) end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--decEq-975'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V5 of {'Idris.Prelude.Types.No', E0} -> (fun (V8) -> {'Idris.Prelude.Types.No', fun (V9) -> (V8(('Idris.Idris2.Builtin':'un--fst'(('un--pairInjective'(V9)))))) end} end(E0)); {'Idris.Prelude.Types.Yes', E1} -> (fun (V10) -> case V10 of 0 -> ('with--with block in decEq-1034'('erased', 'erased', V2, V6, V7, ((('Idris.Idris2.Builtin':'un--snd'(V2))(V6))(V7)), V3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--decEq-853'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V6) -> case V6 of 0 -> {'Idris.Prelude.Types.Yes', 0}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V7) -> {'Idris.Prelude.Types.No', fun (V8) -> (V7(('Idris.Idris2.Data.Either':'un--rightInjective'(V8)))) end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--decEq-752'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V6) -> case V6 of 0 -> {'Idris.Prelude.Types.Yes', 0}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V7) -> {'Idris.Prelude.Types.No', fun (V8) -> (V7(('Idris.Idris2.Data.Either':'un--leftInjective'(V8)))) end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--decEq-682'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V5) -> {'Idris.Prelude.Types.Yes', ('Idris.Idris2.Prelude.Basics':'un--cong'(V5))} end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V6) -> {'Idris.Prelude.Types.No', fun (V7) -> (V6(('Idris.Idris2.Data.Maybe':'un--justInjective'(V7)))) end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--decEq-582'(V0, V1, V2) -> case V2 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V3) -> {'Idris.Prelude.Types.Yes', ('Idris.Idris2.Prelude.Basics':'un--cong'(V3))} end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V4) -> {'Idris.Prelude.Types.No', fun (V5) -> (V4(('Idris.Idris2.Data.Nat':'un--succInjective'(V5)))) end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--decEq-1650'(V0, V1, V2) -> case V2 of 1 -> {'Idris.Prelude.Types.Yes', ('nested--3833-1610--in--un--primitiveEq'(V0, V1))}; 0 -> {'Idris.Prelude.Types.No', fun (V3) -> ('nested--3833-1611--in--un--primitiveNotEq'(V0, V1, V3)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--decEq-1579'(V0, V1, V2) -> case V2 of 1 -> {'Idris.Prelude.Types.Yes', ('nested--3756-1539--in--un--primitiveEq'(V0, V1))}; 0 -> {'Idris.Prelude.Types.No', fun (V3) -> ('nested--3756-1540--in--un--primitiveNotEq'(V0, V1, V3)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--decEq-1508'(V0, V1, V2) -> case V2 of 1 -> {'Idris.Prelude.Types.Yes', ('nested--3679-1468--in--un--primitiveEq'(V0, V1))}; 0 -> {'Idris.Prelude.Types.No', fun (V3) -> ('nested--3679-1469--in--un--primitiveNotEq'(V0, V1, V3)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--decEq-1437'(V0, V1, V2) -> case V2 of 1 -> {'Idris.Prelude.Types.Yes', ('nested--3602-1397--in--un--primitiveEq'(V0, V1))}; 0 -> {'Idris.Prelude.Types.No', fun (V3) -> ('nested--3602-1398--in--un--primitiveNotEq'(V0, V1, V3)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3833-1611--in--un--primitiveNotEq'(V0, V1, V2) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--3756-1540--in--un--primitiveNotEq'(V0, V1, V2) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--3679-1469--in--un--primitiveNotEq'(V0, V1, V2) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--3602-1398--in--un--primitiveNotEq'(V0, V1, V2) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--3833-1610--in--un--primitiveEq'(V0, V1) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--3756-1539--in--un--primitiveEq'(V0, V1) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--3679-1468--in--un--primitiveEq'(V0, V1) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'nested--3602-1397--in--un--primitiveEq'(V0, V1) -> ('Idris.Idris2.Builtin':'un--believe_me'(0)).
'dn--un--decEq_DecEq_String'(V0, V1) -> case ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_String'(V0, V1)) of 1 -> {'Idris.Prelude.Types.Yes', ('nested--3833-1610--in--un--primitiveEq'(V1, V0))}; 0 -> {'Idris.Prelude.Types.No', fun (V2) -> ('nested--3833-1611--in--un--primitiveNotEq'(V1, V0, V2)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--decEq_DecEq_Nat'(V0, V1) -> case V0 of 0 -> case V1 of 0 -> {'Idris.Prelude.Types.Yes', 0}; _ -> {'Idris.Prelude.Types.No', fun (V2) -> ('Idris.Idris2.Prelude.Uninhabited':'un--absurd'(fun (V3) -> ('Idris.Idris2.Data.Nat':'dn--un--uninhabited_Uninhabited_(|((=== Z) (S $n)),((~=~ Z) (S $n))|)'(V3)) end, V2)) end} end; _ -> begin (V4 = (V0 - 1)), case V1 of 0 -> {'Idris.Prelude.Types.No', fun (V5) -> ('Idris.Idris2.Prelude.Uninhabited':'un--absurd'(fun (V6) -> ('Idris.Idris2.Data.Nat':'dn--un--uninhabited_Uninhabited_(|((=== (S $n)) Z),((~=~ (S $n)) Z)|)'(V6)) end, V5)) end}; _ -> begin (V7 = (V1 - 1)), ('with--decEq-582'(V4, V7, ('dn--un--decEq_DecEq_Nat'(V4, V7)))) end end end end.
'dn--un--decEq_DecEq_Integer'(V0, V1) -> case ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Integer'(V0, V1)) of 1 -> {'Idris.Prelude.Types.Yes', ('nested--3756-1539--in--un--primitiveEq'(V1, V0))}; 0 -> {'Idris.Prelude.Types.No', fun (V2) -> ('nested--3756-1540--in--un--primitiveNotEq'(V1, V0, V2)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--decEq_DecEq_Int'(V0, V1) -> case ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Int'(V0, V1)) of 1 -> {'Idris.Prelude.Types.Yes', ('nested--3602-1397--in--un--primitiveEq'(V1, V0))}; 0 -> {'Idris.Prelude.Types.No', fun (V2) -> ('nested--3602-1398--in--un--primitiveNotEq'(V1, V0, V2)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--decEq_DecEq_Char'(V0, V1) -> case ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Char'(V0, V1)) of 1 -> {'Idris.Prelude.Types.Yes', ('nested--3679-1468--in--un--primitiveEq'(V1, V0))}; 0 -> {'Idris.Prelude.Types.No', fun (V2) -> ('nested--3679-1469--in--un--primitiveNotEq'(V1, V0, V2)) end}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
