...
-export([
  'case--systemCmd-1462'/2,
  'un--systemCmd'/2,
  'un--setupTerm'/1,
  'un--getTermLines'/1,
  'un--getTermCols'/1
]).
'case--systemCmd-1462'(V0, V1) -> case V1 of E0 -> (fun (V2) -> fun (V3) -> V2 end end((fun (V4) -> ('unicode':'characters_to_binary'(V4)) end(E0)))); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
