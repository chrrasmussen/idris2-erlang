...
'rf--nextName'(V0) -> case V0 of {'Idris.Compiler.LambdaLift.MkLDefs', E0, E1, E2} -> (fun (V1, V2, V3) -> V3 end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--defs'(V0) -> case V0 of {'Idris.Compiler.LambdaLift.MkLDefs', E0, E1, E2} -> (fun (V1, V2, V3) -> V2 end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--basename'(V0) -> case V0 of {'Idris.Compiler.LambdaLift.MkLDefs', E0, E1, E2} -> (fun (V1, V2, V3) -> V1 end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
