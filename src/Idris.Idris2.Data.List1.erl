...
-export([
  'case--case block in unzipWith3-2258'/7,
  'case--unzipWith3-2229'/4,
  'case--case block in unzipWith3,unzipWith3\x{27}-2172'/9,
  'case--unzipWith3,unzipWith3\x{27}-2138'/6,
  'case--case block in unzipWith-2070'/6,
  'case--unzipWith-2047'/4,
  'case--case block in unzipWith,unzipWith\x{27}-2005'/8,
  'case--unzipWith,unzipWith\x{27}-1977'/6,
  'case--unsnoc-924'/4,
  'nested--3059-1913--in--un--zipWith3\x{27}'/10,
  'nested--3051-1872--in--un--zipWith\x{27}'/7,
  'nested--3078-2116--in--un--unzipWith3\x{27}'/4,
  'nested--3070-1961--in--un--unzipWith\x{27}'/4,
  'nested--2106-810--in--un--loop'/6,
  'nested--2085-787--in--un--loop'/4,
  'nested--2066-771--in--un--loop'/4,
...
'case--case block in unzipWith3-2258'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V7, V8) -> case V8 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V9, V10) -> {'Idris.Builtin.MkPair', {'Idris.Data.List1.:::', V3, V7}, {'Idris.Builtin.MkPair', {'Idris.Data.List1.:::', V4, V9}, {'Idris.Data.List1.:::', V5, V10}}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzipWith3-2229'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> case ('nested--3078-2116--in--un--unzipWith3\x{27}'(V0, V1, V2, V1)) of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V8, V9) -> case V9 of {'Idris.Builtin.MkPair', E6, E7} -> (fun (V10, V11) -> {'Idris.Builtin.MkPair', {'Idris.Data.List1.:::', V4, V8}, {'Idris.Builtin.MkPair', {'Idris.Data.List1.:::', V6, V10}, {'Idris.Data.List1.:::', V7, V11}}} end(E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in unzipWith3,unzipWith3\x{27}-2172'(V0, V1, V2, V3, V4, V5, V6, V7, V8) -> case V8 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V9, V10) -> case V10 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V11, V12) -> {'Idris.Builtin.MkPair', [V5 | V9], {'Idris.Builtin.MkPair', [V6 | V11], [V7 | V12]}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzipWith3,unzipWith3\x{27}-2138'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> case V7 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V8, V9) -> case ('nested--3078-2116--in--un--unzipWith3\x{27}'(V0, V1, V2, V4)) of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V10, V11) -> case V11 of {'Idris.Builtin.MkPair', E6, E7} -> (fun (V12, V13) -> {'Idris.Builtin.MkPair', [V6 | V10], {'Idris.Builtin.MkPair', [V8 | V12], [V9 | V13]}} end(E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in unzipWith-2070'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', {'Idris.Data.List1.:::', V3, V6}, {'Idris.Data.List1.:::', V4, V7}} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzipWith-2047'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case ('nested--3070-1961--in--un--unzipWith\x{27}'(V0, V1, V2, V1)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', {'Idris.Data.List1.:::', V4, V6}, {'Idris.Data.List1.:::', V5, V7}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in unzipWith,unzipWith\x{27}-2005'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V7 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V8, V9) -> {'Idris.Builtin.MkPair', [V5 | V8], [V6 | V9]} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzipWith,unzipWith\x{27}-1977'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> case ('nested--3070-1961--in--un--unzipWith\x{27}'(V0, V1, V2, V4)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V8, V9) -> {'Idris.Builtin.MkPair', [V6 | V8], [V7 | V9]} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unsnoc-924'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', [V0 | V4], V5} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3059-1913--in--un--zipWith3\x{27}'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) -> case V7 of [] -> []; _ -> case V8 of [] -> []; _ -> case V9 of [] -> []; _ -> case V7 of [E0 | E1] -> (fun (V10, V11) -> case V8 of [E2 | E3] -> (fun (V12, V13) -> case V9 of [E4 | E5] -> (fun (V14, V15) -> [(((V6(V10))(V12))(V14)) | ('nested--3059-1913--in--un--zipWith3\x{27}'(V0, V1, V2, V3, V4, V5, V6, V11, V13, V15))] end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end.
'nested--3051-1872--in--un--zipWith\x{27}'(V0, V1, V2, V3, V4, V5, V6) -> case V5 of [] -> []; _ -> case V6 of [] -> []; _ -> case V5 of [E0 | E1] -> (fun (V7, V8) -> case V6 of [E2 | E3] -> (fun (V9, V10) -> [((V4(V7))(V9)) | ('nested--3051-1872--in--un--zipWith\x{27}'(V0, V1, V2, V3, V4, V8, V10))] end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end.
'nested--3078-2116--in--un--unzipWith3\x{27}'(V0, V1, V2, V3) -> case V3 of [] -> {'Idris.Builtin.MkPair', [], {'Idris.Builtin.MkPair', [], []}}; [E0 | E1] -> (fun (V4, V5) -> case (V2(V4)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> case V7 of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V8, V9) -> case ('nested--3078-2116--in--un--unzipWith3\x{27}'(V0, V1, V2, V5)) of {'Idris.Builtin.MkPair', E6, E7} -> (fun (V10, V11) -> case V11 of {'Idris.Builtin.MkPair', E8, E9} -> (fun (V12, V13) -> {'Idris.Builtin.MkPair', [V6 | V10], {'Idris.Builtin.MkPair', [V8 | V12], [V9 | V13]}} end(E8, E9)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3070-1961--in--un--unzipWith\x{27}'(V0, V1, V2, V3) -> case V3 of [] -> {'Idris.Builtin.MkPair', [], []}; [E0 | E1] -> (fun (V4, V5) -> case (V2(V4)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> case ('nested--3070-1961--in--un--unzipWith\x{27}'(V0, V1, V2, V5)) of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V8, V9) -> {'Idris.Builtin.MkPair', [V6 | V8], [V7 | V9]} end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2106-810--in--un--loop'(V0, V1, V2, V3, V4, V5) -> case V5 of [] -> (V2(V4)); [E0 | E1] -> (fun (V6, V7) -> ((V3(V4))(('nested--2106-810--in--un--loop'(V0, V1, V2, V3, V6, V7)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2085-787--in--un--loop'(V0, V1, V2, V3) -> case V3 of [] -> []; [E0 | E1] -> (fun (V4, V5) -> [V2 | ('nested--2085-787--in--un--loop'(V0, V1, V4, V5))] end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2066-771--in--un--loop'(V0, V1, V2, V3) -> case V3 of [] -> V2; [E0 | E1] -> (fun (V4, V5) -> ('nested--2066-771--in--un--loop'(V0, V1, V4, V5)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--zip_Zippable_List1'(V0, V1) -> ('dn--un--zipWith_Zippable_List1'(fun (V2) -> fun (V3) -> {'Idris.Builtin.MkPair', V2, V3} end end, V0, V1)).
'dn--un--zipWith_Zippable_List1'(V0, V1, V2) -> case V1 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V3, V4) -> case V2 of {'Idris.Data.List1.:::', E2, E3} -> (fun (V5, V6) -> {'Idris.Data.List1.:::', ((V0(V3))(V5)), ('nested--3051-1872--in--un--zipWith\x{27}'(V3, V4, V5, V6, V0, V4, V6))} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--zipWith3_Zippable_List1'(V0, V1, V2, V3) -> case V1 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V4, V5) -> case V2 of {'Idris.Data.List1.:::', E2, E3} -> (fun (V6, V7) -> case V3 of {'Idris.Data.List1.:::', E4, E5} -> (fun (V8, V9) -> {'Idris.Data.List1.:::', (((V0(V4))(V6))(V8)), ('nested--3059-1913--in--un--zipWith3\x{27}'(V4, V5, V6, V7, V8, V9, V0, V5, V7, V9))} end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--last'(V0) -> case V0 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V1, V2) -> ('nested--2066-771--in--un--loop'(V1, V2, V1, V2)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--init'(V0) -> case V0 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V1, V2) -> ('nested--2085-787--in--un--loop'(V1, V2, V1, V2)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--foldr1By'(V0, V1, V2) -> case V2 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V3, V4) -> ('nested--2106-810--in--un--loop'(V3, V4, V1, V0, V3, V4)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
