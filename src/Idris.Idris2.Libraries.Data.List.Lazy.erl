...
-export([
  'case--mapMaybe-1255'/4,
  'case--filter-1204'/4,
  'case--dropWhile-1160'/4,
  'case--takeWhile-1115'/4,
  'case--unfoldr-954'/3,
  'case--iterate-918'/3,
...
'case--mapMaybe-1255'(V0, V1, V2, V3) -> case V3 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> ('un--mapMaybe'(V2, (V1()))) end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V4) -> {'Idris.Libraries.Data.List.Lazy.::', V4, fun () -> ('un--mapMaybe'(V2, (V1()))) end} end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--filter-1204'(V0, V1, V2, V3) -> case V3 of 1 -> {'Idris.Libraries.Data.List.Lazy.::', V0, fun () -> ('un--filter'(V2, (V1()))) end}; 0 -> ('un--filter'(V2, (V1()))); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--dropWhile-1160'(V0, V1, V2, V3) -> case V3 of 1 -> ('un--dropWhile'(V2, (V1()))); 0 -> {'Idris.Libraries.Data.List.Lazy.::', V0, V1}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--takeWhile-1115'(V0, V1, V2, V3) -> case V3 of 1 -> {'Idris.Libraries.Data.List.Lazy.::', V0, fun () -> ('un--takeWhile'(V2, (V1()))) end}; 0 -> {'Idris.Libraries.Data.List.Lazy.Nil'}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unfoldr-954'(V0, V1, V2) -> case V2 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> {'Idris.Libraries.Data.List.Lazy.Nil'} end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V3) -> case V3 of {'Idris.Builtin.MkPair', E1, E2} -> (fun (V4, V5) -> {'Idris.Libraries.Data.List.Lazy.::', V4, fun () -> ('un--unfoldr'(V1, V5)) end} end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--iterate-918'(V0, V1, V2) -> case V2 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> fun () -> {'Idris.Libraries.Data.List.Lazy.Nil'} end end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V3) -> fun () -> ('un--iterate'(V1, V3)) end end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
