...
'dn--un--show_Show_Namespace'(V0) -> ('un--showSep'(<<"."/utf8>>, ('Idris.Idris2.Data.List':'un--reverse'('erased', V0)))).
'dn--un--show_Show_Name'(V0) -> case V0 of {'Idris.Language.Reflection.TT.NS', E0, E1} -> (fun (V1, V2) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(('dn--un--show_Show_Namespace'(V1)), ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"."/utf8>>, ('dn--un--show_Show_Name'(V2)))))) end(E0, E1)); {'Idris.Language.Reflection.TT.UN', E2} -> (fun (V3) -> V3 end(E2)); {'Idris.Language.Reflection.TT.MN', E3, E4} -> (fun (V4, V5) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"{"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(V4, ('Idris.Idris2.Prelude.Types.String':'un--++'(<<":"/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Int'(V5)), <<"}"/utf8>>)))))))) end(E3, E4)); {'Idris.Language.Reflection.TT.DN', E5, E6} -> (fun (V6, V7) -> V6 end(E5, E6)); {'Idris.Language.Reflection.TT.RF', E7} -> (fun (V8) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"."/utf8>>, V8)) end(E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
