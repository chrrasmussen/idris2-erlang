...
-export([
  'case--parseIPv4-4253'/2,
  'case--nullPtr-3962'/4,
  'nested--3094-4228--in--un--toInt\x{27}'/2,
  'nested--3094-4229--in--un--toInt'/2,
  'nested--3094-4230--in--un--splitted'/1,
...
'case--parseIPv4-4253'(V0, V1) -> case V1 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V2, V3) -> case V3 of [E2 | E3] -> (fun (V4, V5) -> case V5 of [E4 | E5] -> (fun (V6, V7) -> case V7 of [E6 | E7] -> (fun (V8, V9) -> {'Idris.Network.Socket.Data.IPv4Addr', V2, V4, V6, V8} end(E6, E7)); _ -> {'Idris.Network.Socket.Data.InvalidAddress'} end end(E4, E5)); _ -> {'Idris.Network.Socket.Data.InvalidAddress'} end end(E2, E3)); _ -> {'Idris.Network.Socket.Data.InvalidAddress'} end end(E0, E1)); _ -> {'Idris.Network.Socket.Data.InvalidAddress'} end.
'case--nullPtr-3962'(V0, V1, V2, V3) -> case V3 of 0 -> case case case V1 of {'Idris.Prelude.IO.dn--un--__mkHasIO', E14, E15} -> (fun (V4, V5) -> V4 end(E14, E15)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end of {'Idris.Prelude.Interfaces.dn--un--__mkMonad', E11, E12, E13} -> (fun (V6, V7, V8) -> V6 end(E11, E12, E13)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end of {'Idris.Prelude.Interfaces.dn--un--__mkApplicative', E8, E9, E10} -> (fun (V9, V10, V11) -> ((V10('erased'))(1)) end(E8, E9, E10)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end; _ -> case case case V1 of {'Idris.Prelude.IO.dn--un--__mkHasIO', E6, E7} -> (fun (V12, V13) -> V12 end(E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end of {'Idris.Prelude.Interfaces.dn--un--__mkMonad', E3, E4, E5} -> (fun (V14, V15, V16) -> V14 end(E3, E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end of {'Idris.Prelude.Interfaces.dn--un--__mkApplicative', E0, E1, E2} -> (fun (V17, V18, V19) -> ((V18('erased'))(0)) end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end.
'nested--3094-4228--in--un--toInt\x{27}'(V0, V1) -> ('Idris.Idris2.Prelude.Cast':'dn--un--cast_Cast_String_Integer'(V1)).
'nested--3094-4229--in--un--toInt'(V0, V1) -> ('nested--3094-4228--in--un--toInt\x{27}'(V0, V1)).
'nested--3094-4230--in--un--splitted'(V0) -> ('Idris.Idris2.Data.List1':'dn--un--map_Functor_List1'('erased', 'erased', fun (V1) -> ('nested--3094-4229--in--un--toInt'(V0, V1)) end, ('Idris.Idris2.Data.String':'un--split'(fun (V2) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Char'(V2, $.)) end, V0)))).
'dn--un--toCode_ToCode_SocketType'(V0) -> case V0 of {'Idris.Network.Socket.Data.NotASocket'} -> (fun () -> 0 end()); {'Idris.Network.Socket.Data.Stream'} -> (fun () -> 1 end()); {'Idris.Network.Socket.Data.Datagram'} -> (fun () -> 2 end()); {'Idris.Network.Socket.Data.RawSocket'} -> (fun () -> 3 end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--toCode_ToCode_SocketFamily'(V0) -> case V0 of {'Idris.Network.Socket.Data.AF_UNSPEC'} -> (fun () -> ('Idris.Idris2.PrimIO':'un--unsafePerformIO'('erased', fun (V1) -> ('un--prim__idrnet_af_unspec'(V1)) end)) end()); {'Idris.Network.Socket.Data.AF_UNIX'} -> (fun () -> ('Idris.Idris2.PrimIO':'un--unsafePerformIO'('erased', fun (V2) -> ('un--prim__idrnet_af_unix'(V2)) end)) end()); {'Idris.Network.Socket.Data.AF_INET'} -> (fun () -> ('Idris.Idris2.PrimIO':'un--unsafePerformIO'('erased', fun (V3) -> ('un--prim__idrnet_af_inet'(V3)) end)) end()); {'Idris.Network.Socket.Data.AF_INET6'} -> (fun () -> ('Idris.Idris2.PrimIO':'un--unsafePerformIO'('erased', fun (V4) -> ('un--prim__idrnet_af_inet6'(V4)) end)) end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--show_Show_SocketType'(V0) -> case V0 of {'Idris.Network.Socket.Data.NotASocket'} -> (fun () -> <<"Not a socket"/utf8>> end()); {'Idris.Network.Socket.Data.Stream'} -> (fun () -> <<"Stream"/utf8>> end()); {'Idris.Network.Socket.Data.Datagram'} -> (fun () -> <<"Datagram"/utf8>> end()); {'Idris.Network.Socket.Data.RawSocket'} -> (fun () -> <<"Raw"/utf8>> end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--show_Show_SocketAddress'(V0) -> case V0 of {'Idris.Network.Socket.Data.IPv4Addr', E0, E1, E2, E3} -> (fun (V1, V2, V3, V4) -> (('Idris.Idris2.Prelude.Interfaces':'un--concat'('erased', 'erased', {'Idris.Builtin.MkPair', {'Idris.Prelude.Interfaces.dn--un--__mkFoldable', fun (V6) -> fun (V7) -> fun (V8) -> fun (V9) -> fun (V10) -> ('Idris.Idris2.Prelude.Types':'dn--un--foldr_Foldable_List'('erased', 'erased', V8, V9, V10)) end end end end end, fun (V11) -> fun (V12) -> fun (V13) -> fun (V14) -> fun (V15) -> ('Idris.Idris2.Prelude.Types':'dn--un--foldl_Foldable_List'('erased', 'erased', V13, V14, V15)) end end end end end, fun (V16) -> fun (V17) -> ('Idris.Idris2.Prelude.Types':'dn--un--null_Foldable_List'('erased', V17)) end end}, {'Idris.Prelude.Interfaces.dn--un--__mkMonoid', fun (V18) -> fun (V19) -> ('Idris.Idris2.Prelude.Types':'dn--un--<+>_Semigroup_String'(V18, V19)) end end, ('Idris.Idris2.Prelude.Types':'dn--un--neutral_Monoid_String'())}}))(('Idris.Idris2.Data.List':'un--intersperse'('erased', <<"."/utf8>>, ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_List'('erased', 'erased', fun (V5) -> ('Idris.Idris2.Prelude.Show':'dn--un--show_Show_Int'(V5)) end, [V1 | [V2 | [V3 | [V4 | []]]]])))))) end(E0, E1, E2, E3)); {'Idris.Network.Socket.Data.IPv6Addr'} -> (fun () -> <<"NOT IMPLEMENTED YET"/utf8>> end()); {'Idris.Network.Socket.Data.Hostname', E4} -> (fun (V20) -> V20 end(E4)); {'Idris.Network.Socket.Data.InvalidAddress'} -> (fun () -> <<"Invalid"/utf8>> end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--__Impl_Show_SocketType'() -> {'Idris.Prelude.Show.dn--un--__mkShow', fun (V0) -> ('dn--un--show_Show_SocketType'(V0)) end, fun (V1) -> fun (V2) -> ('dn--un--showPrec_Show_SocketType'(V1, V2)) end end}.
'dn--un--__Impl_Show_SocketAddress'() -> {'Idris.Prelude.Show.dn--un--__mkShow', fun (V0) -> ('dn--un--show_Show_SocketAddress'(V0)) end, fun (V1) -> fun (V2) -> ('dn--un--showPrec_Show_SocketAddress'(V1, V2)) end end}.
...
'un--parseIPv4'(V0) -> ('case--parseIPv4-4253'(V0, ('nested--3094-4230--in--un--splitted'(V0)))).
...
'un--getSocketFamily'(V0) -> ('Idris.Idris2.Data.List':'un--lookup'('erased', 'erased', {'Idris.Prelude.EqOrd.dn--un--__mkEq', fun (V1) -> fun (V2) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Int'(V1, V2)) end end, fun (V3) -> fun (V4) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--/=_Eq_Int'(V3, V4)) end end}, V0, [{'Idris.Builtin.MkPair', ('dn--un--toCode_ToCode_SocketFamily'({'Idris.Network.Socket.Data.AF_UNSPEC'})), {'Idris.Network.Socket.Data.AF_UNSPEC'}} | [{'Idris.Builtin.MkPair', ('dn--un--toCode_ToCode_SocketFamily'({'Idris.Network.Socket.Data.AF_UNIX'})), {'Idris.Network.Socket.Data.AF_UNIX'}} | [{'Idris.Builtin.MkPair', ('dn--un--toCode_ToCode_SocketFamily'({'Idris.Network.Socket.Data.AF_INET'})), {'Idris.Network.Socket.Data.AF_INET'}} | [{'Idris.Builtin.MkPair', ('dn--un--toCode_ToCode_SocketFamily'({'Idris.Network.Socket.Data.AF_INET6'})), {'Idris.Network.Socket.Data.AF_INET6'}} | []]]]])).
