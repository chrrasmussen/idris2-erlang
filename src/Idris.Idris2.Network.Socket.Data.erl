...
-export([
  'nested--2808-3973--in--un--toInt\x{27}'/2,
  'nested--2808-3974--in--un--toInt'/2,
  'nested--2808-3975--in--un--splitted'/1,
...
'nested--2808-3973--in--un--toInt\x{27}'(V0, V1) -> ('Idris.Idris2.Prelude.Cast':'dn--un--cast_Cast_String_Integer'(V1)).
'nested--2808-3974--in--un--toInt'(V0, V1) -> ('nested--2808-3973--in--un--toInt\x{27}'(V0, V1)).
'nested--2808-3975--in--un--splitted'(V0) -> ('Idris.Idris2.Data.List1':'dn--un--map_Functor_List1'(fun (V1) -> ('nested--2808-3974--in--un--toInt'(V0, V1)) end, ('Idris.Idris2.Data.String':'un--split'(fun (V2) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Char'(V2, $.)) end, V0)))).
