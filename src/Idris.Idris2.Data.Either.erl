...
'un--pushInto'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Prelude.Types.Left', E0} -> (fun (V5) -> {'Idris.Prelude.Types.Left', {'Idris.Builtin.MkPair', V3, V5}} end(E0)); {'Idris.Prelude.Types.Right', E1} -> (fun (V6) -> {'Idris.Prelude.Types.Right', {'Idris.Builtin.MkPair', V3, V6}} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--decompress'(V0, V1) -> ('Idris.Idris2.Prelude.Interfaces':'un--concatMap'('erased', 'erased', 'erased', {'Idris.Builtin.MkPair', {'Idris.Prelude.Interfaces.dn--un--__mkFoldable', fun (V2) -> fun (V3) -> fun (V4) -> fun (V5) -> fun (V6) -> ('Idris.Idris2.Prelude.Types':'dn--un--foldr_Foldable_List'('erased', 'erased', V4, V5, V6)) end end end end end, fun (V7) -> fun (V8) -> fun (V9) -> fun (V10) -> fun (V11) -> ('Idris.Idris2.Prelude.Types':'dn--un--foldl_Foldable_List'('erased', 'erased', V9, V10, V11)) end end end end end, fun (V12) -> fun (V13) -> ('Idris.Idris2.Prelude.Types':'dn--un--null_Foldable_List'('erased', V13)) end end}, {'Idris.Prelude.Interfaces.dn--un--__mkMonoid', fun (V14) -> fun (V15) -> ('Idris.Idris2.Prelude.Types':'dn--un--<+>_Semigroup_(List $a)'('erased', V14, V15)) end end, ('Idris.Idris2.Prelude.Types':'dn--un--neutral_Monoid_(List $a)'('erased'))}}, fun (V16) -> case V16 of {'Idris.Prelude.Types.Left', E0} -> (fun (V17) -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_List'('erased', 'erased', fun (V18) -> {'Idris.Prelude.Types.Left', V18} end, ('Idris.Idris2.Data.List1':'un--forget'('erased', V17)))) end(E0)); {'Idris.Prelude.Types.Right', E1} -> (fun (V19) -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_List'('erased', 'erased', fun (V20) -> {'Idris.Prelude.Types.Right', V20} end, ('Idris.Idris2.Data.List1':'un--forget'('erased', V19)))) end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end)).
