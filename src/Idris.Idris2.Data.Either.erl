...
'un--compressRights'(V0, V1) -> case V1 of [E0 | E1] -> (fun (V2, V3) -> case V2 of {'Idris.Prelude.Types.Right', E2} -> (fun (V4) -> ('un--compressRights'(('Idris.Idris2.Data.List1':'un--cons'(V4, V0)), V3)) end(E2)); _ -> [{'Idris.Prelude.Types.Right', ('Idris.Idris2.Data.List1':'un--reverse'(V0))} | ('un--compress'(V1))] end end(E0, E1)); _ -> [{'Idris.Prelude.Types.Right', ('Idris.Idris2.Data.List1':'un--reverse'(V0))} | ('un--compress'(V1))] end.
'un--compressLefts'(V0, V1) -> case V1 of [E0 | E1] -> (fun (V2, V3) -> case V2 of {'Idris.Prelude.Types.Left', E2} -> (fun (V4) -> ('un--compressLefts'(('Idris.Idris2.Data.List1':'un--cons'(V4, V0)), V3)) end(E2)); _ -> [{'Idris.Prelude.Types.Left', ('Idris.Idris2.Data.List1':'un--reverse'(V0))} | ('un--compress'(V1))] end end(E0, E1)); _ -> [{'Idris.Prelude.Types.Left', ('Idris.Idris2.Data.List1':'un--reverse'(V0))} | ('un--compress'(V1))] end.
'un--compress'(V0) -> case V0 of [] -> []; [E0 | E1] -> (fun (V1, V2) -> case V1 of {'Idris.Prelude.Types.Left', E2} -> (fun (V3) -> ('un--compressLefts'(('Idris.Idris2.Data.List1':'un--singleton'(V3)), V2)) end(E2)); {'Idris.Prelude.Types.Right', E3} -> (fun (V4) -> ('un--compressRights'(('Idris.Idris2.Data.List1':'un--singleton'(V4)), V2)) end(E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
