...
-export([
  'dn--un--pure_Applicative_IO'/3,
  'dn--un--map_Functor_IO'/5,
  'dn--un--liftIO_HasIO_$io'/4,
  'dn--un--liftIO1_HasLinearIO_IO'/2,
  'dn--un--join_Monad_IO'/3,
  'dn--un--__Impl_Monad_IO'/0,
  'dn--un--__Impl_HasLinearIO_IO'/0,
  'dn--un--__Impl_HasIO_$io'/2,
  'dn--un--__Impl_Functor_IO'/5,
  'dn--un--__Impl_Applicative_IO'/0,
  'dn--un--__HasLinearIO_(Monad io)'/2,
  'dn--un--__HasIO_(Monad io)'/2,
  'dn--un-->>=_Monad_IO'/5,
  'dn--un--<*>_Applicative_IO'/5,
  'un--threadWait'/2,
  'un--putStrLn'/3,
  'un--putStr'/3,
  'un--putCharLn'/3,
...
'dn--un--pure_Applicative_IO'(V0, V1, V2) -> V1.
'dn--un--map_Functor_IO'(V0, V1, V2, V3, V4) -> begin (V5 = (V3(V4))), (V2(V5)) end.
'dn--un--liftIO_HasIO_$io'(V0, V1, V2, V3) -> case V2 of {'Idris.Prelude.IO.dn--un--__mkHasLinearIO', E0, E1} -> (fun (V4, V5) -> ((V5('erased'))(V3)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--liftIO1_HasLinearIO_IO'(V0, V1) -> V1.
'dn--un--join_Monad_IO'(V0, V1, V2) -> begin (V3 = (V1(V2))), (V3(V2)) end.
'dn--un--__Impl_Monad_IO'() -> {'Idris.Prelude.Interfaces.dn--un--__mkMonad', {'Idris.Prelude.Interfaces.dn--un--__mkApplicative', fun (V0) -> fun (V1) -> fun (V2) -> fun (V3) -> fun (V4) -> ('dn--un--map_Functor_IO'('erased', 'erased', V2, V3, V4)) end end end end end, fun (V5) -> fun (V6) -> fun (V7) -> V6 end end end, fun (V8) -> fun (V9) -> fun (V10) -> fun (V11) -> fun (V12) -> begin (V13 = (V10(V12))), begin (V14 = (V11(V12))), (V13(V14)) end end end end end end end}, fun (V15) -> fun (V16) -> fun (V17) -> fun (V18) -> fun (V19) -> begin (V20 = (V17(V19))), ((V18(V20))(V19)) end end end end end end, fun (V21) -> fun (V22) -> fun (V23) -> begin (V24 = (V22(V23))), (V24(V23)) end end end end}.
'dn--un--__Impl_HasLinearIO_IO'() -> {'Idris.Prelude.IO.dn--un--__mkHasLinearIO', {'Idris.Prelude.Interfaces.dn--un--__mkMonad', {'Idris.Prelude.Interfaces.dn--un--__mkApplicative', fun (V0) -> fun (V1) -> fun (V2) -> fun (V3) -> fun (V4) -> ('dn--un--map_Functor_IO'('erased', 'erased', V2, V3, V4)) end end end end end, fun (V5) -> fun (V6) -> fun (V7) -> V6 end end end, fun (V8) -> fun (V9) -> fun (V10) -> fun (V11) -> fun (V12) -> begin (V13 = (V10(V12))), begin (V14 = (V11(V12))), (V13(V14)) end end end end end end end}, fun (V15) -> fun (V16) -> fun (V17) -> fun (V18) -> fun (V19) -> begin (V20 = (V17(V19))), ((V18(V20))(V19)) end end end end end end, fun (V21) -> fun (V22) -> fun (V23) -> begin (V24 = (V22(V23))), (V24(V23)) end end end end}, fun (V25) -> fun (V26) -> V26 end end}.
'dn--un--__Impl_HasIO_$io'(V0, V1) -> {'Idris.Prelude.IO.dn--un--__mkHasIO', case V1 of {'Idris.Prelude.IO.dn--un--__mkHasLinearIO', E0, E1} -> (fun (V2, V3) -> V2 end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end, fun (V4) -> fun (V5) -> case V1 of {'Idris.Prelude.IO.dn--un--__mkHasLinearIO', E2, E3} -> (fun (V6, V7) -> ((V7('erased'))(V5)) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end}.
'dn--un--__Impl_Functor_IO'(V0, V1, V2, V3, V4) -> ('dn--un--map_Functor_IO'('erased', 'erased', V2, V3, V4)).
'dn--un--__Impl_Applicative_IO'() -> {'Idris.Prelude.Interfaces.dn--un--__mkApplicative', fun (V0) -> fun (V1) -> fun (V2) -> fun (V3) -> fun (V4) -> ('dn--un--map_Functor_IO'('erased', 'erased', V2, V3, V4)) end end end end end, fun (V5) -> fun (V6) -> fun (V7) -> V6 end end end, fun (V8) -> fun (V9) -> fun (V10) -> fun (V11) -> fun (V12) -> begin (V13 = (V10(V12))), begin (V14 = (V11(V12))), (V13(V14)) end end end end end end end}.
'dn--un--__HasLinearIO_(Monad io)'(V0, V1) -> case V1 of {'Idris.Prelude.IO.dn--un--__mkHasLinearIO', E0, E1} -> (fun (V2, V3) -> V2 end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un-->>=_Monad_IO'(V0, V1, V2, V3, V4) -> begin (V5 = (V2(V4))), ((V3(V5))(V4)) end.
'dn--un--<*>_Applicative_IO'(V0, V1, V2, V3, V4) -> begin (V5 = (V2(V4))), begin (V6 = (V3(V4))), (V5(V6)) end end.
...
'un--primIO1'(V0, V1, V2, V3) -> case V2 of {'Idris.Prelude.IO.dn--un--__mkHasLinearIO', E0, E1} -> (fun (V4, V5) -> ((V5('erased'))(V3)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--liftIO1'(V0, V1, V2) -> case V2 of {'Idris.Prelude.IO.dn--un--__mkHasLinearIO', E0, E1} -> (fun (V3, V4) -> fun (V5) -> ((V4('erased'))(V5)) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
