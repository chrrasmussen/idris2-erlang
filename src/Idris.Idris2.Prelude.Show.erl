...
-export([
  'nested--2171-6506--in--un--show\x{27}'/4,
  'nested--1665-6045--in--un--asciiTab'/1,
...
'nested--2171-6506--in--un--show\x{27}'(V0, V1, V2, V3) -> case V3 of [] -> V2; [E0 | E1] -> (fun (V4, V5) -> case V5 of [] -> ('Idris.Idris2.Prelude.Types.String':'un--++'(V2, case V0 of {'Idris.Prelude.Show.MkShow', E4, E5} -> (fun (V6, V7) -> (V6(V4)) end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end)); _ -> ('nested--2171-6506--in--un--show\x{27}'(V0, V1, ('Idris.Idris2.Prelude.Types.String':'un--++'(V2, ('Idris.Idris2.Prelude.Types.String':'un--++'(case V0 of {'Idris.Prelude.Show.MkShow', E2, E3} -> (fun (V8, V9) -> (V8(V4)) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end, <<", "/utf8>>)))), V5)) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--1665-6045--in--un--asciiTab'(V0) -> [<<"NUL"/utf8>> | [<<"SOH"/utf8>> | [<<"STX"/utf8>> | [<<"ETX"/utf8>> | [<<"EOT"/utf8>> | [<<"ENQ"/utf8>> | [<<"ACK"/utf8>> | [<<"BEL"/utf8>> | [<<"BS"/utf8>> | [<<"HT"/utf8>> | [<<"LF"/utf8>> | [<<"VT"/utf8>> | [<<"FF"/utf8>> | [<<"CR"/utf8>> | [<<"SO"/utf8>> | [<<"SI"/utf8>> | [<<"DLE"/utf8>> | [<<"DC1"/utf8>> | [<<"DC2"/utf8>> | [<<"DC3"/utf8>> | [<<"DC4"/utf8>> | [<<"NAK"/utf8>> | [<<"SYN"/utf8>> | [<<"ETB"/utf8>> | [<<"CAN"/utf8>> | [<<"EM"/utf8>> | [<<"SUB"/utf8>> | [<<"ESC"/utf8>> | [<<"FS"/utf8>> | [<<"GS"/utf8>> | [<<"RS"/utf8>> | [<<"US"/utf8>> | []]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]].
...
'dn--un--show_Show_(List $a)'(V0, V1) -> ('Idris.Idris2.Prelude.Types.String':'un--++'(<<"["/utf8>>, ('Idris.Idris2.Prelude.Types.String':'un--++'(('nested--2171-6506--in--un--show\x{27}'(V0, V1, <<""/utf8>>, V1)), <<"]"/utf8>>)))).
