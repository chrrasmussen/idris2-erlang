...
-export([
  'case--unsafePerformIO-523'/4,
  'case--case block in io_bind-444'/8,
  'case--io_bind-422'/6,
  'case--prim__io_bind-386'/6,
...
'case--unsafePerformIO-523'(V0, V1, V2, V3) -> ('un--unsafeDestroyWorld'('erased', 'erased', V3)).
'case--case block in io_bind-444'(V0, V1, V2, V3, V4, V5, V6, V7) -> (V7(V6)).
'case--io_bind-422'(V0, V1, V2, V3, V4, V5) -> ('case--case block in io_bind-444'('erased', 'erased', 'erased', 'erased', 'erased', V5, 'erased', (V3(V5)))).
'case--prim__io_bind-386'(V0, V1, V2, V3, V4, V5) -> ((V3(V5))('erased')).
'un--unsafePerformIO'(V0, V1) -> ('un--unsafeCreateWorld'('erased', fun (V2) -> ('case--unsafePerformIO-523'('erased', V1, 'erased', (V1(V2)))) end)).
...
'un--prim__io_bind'(V0, V1, V2, V3, V4) -> ('case--prim__io_bind-386'('erased', 'erased', 'erased', V3, 'erased', (V2(V4)))).
...
'un--io_bind'(V0, V1, V2, V3, V4) -> ('case--io_bind-422'('erased', 'erased', 'erased', V3, 'erased', (V2(V4)))).
