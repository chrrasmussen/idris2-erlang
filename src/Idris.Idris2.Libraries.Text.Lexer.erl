...
-export([
  'nested--3243-926--in--un--middle'/2,
  'nested--3000-691--in--un--lexStr'/1,
  'nested--3000-692--in--un--control'/0,
  'un--uppers'/0,
  'un--upper'/0,
  'un--toTokenMap'/1,
  'un--symbols'/0,
...
'un--charLit'() -> begin (V0 = $\x{27}), {'Idris.Libraries.Text.Lexer.Core.SeqEat', {'Idris.Libraries.Text.Lexer.Core.SeqEat', ('un--is'(V0)), fun () -> ('Idris.Idris2.Libraries.Text.Lexer.Core':'un--<|>'(('un--escape'(('un--is'($\x{5c})), ('Idris.Idris2.Libraries.Text.Lexer.Core':'un--<|>'(('nested--3000-692--in--un--control'()), ('un--any'()))))), ('un--isNot'(V0)))) end}, fun () -> ('un--is'(V0)) end} end.
'un--blockComment'(V0, V1) -> {'Idris.Libraries.Text.Lexer.Core.SeqEat', {'Idris.Libraries.Text.Lexer.Core.SeqEat', V0, fun () -> ('nested--3243-926--in--un--middle'(V1, V0)) end}, fun () -> V1 end}.
