...
'rf--flags'(V0) -> case V0 of {'Idris.Idris.CommandLine.MkOpt', E0, E1, E2, E3} -> (fun (V1, V2, V3, V4) -> V1 end(E0, E1, E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--argdescs'(V0) -> case V0 of {'Idris.Idris.CommandLine.MkOpt', E0, E1, E2, E3} -> (fun (V1, V2, V3, V4) -> V2 end(E0, E1, E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--action'(V0) -> case V0 of {'Idris.Idris.CommandLine.MkOpt', E0, E1, E2, E3} -> (fun (V1, V2, V3, V4) -> V3 end(E0, E1, E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
