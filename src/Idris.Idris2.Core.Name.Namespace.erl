...
-export([
  'with--decEq-2537'/3,
  'nested--3471-2329--in--un--go'/2,
  'nested--3399-2262--in--un--go'/4,
...
'with--decEq-2537'(V0, V1, V2) -> case V2 of {'Idris.Prelude.Types.No', E0} -> (fun (V3) -> {'Idris.Prelude.Types.No', fun (V4) -> (V3(('un--mkNSInjective'(V4)))) end} end(E0)); {'Idris.Prelude.Types.Yes', E1} -> (fun (V5) -> {'Idris.Prelude.Types.Yes', ('Idris.Idris2.Prelude.Basics':'un--cong'(V5))} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3471-2329--in--un--go'(V0, V1) -> case V1 of [] -> []; [E0 | E1] -> (fun (V2, V3) -> [[V2 | V3] | ('nested--3471-2329--in--un--go'(V0, V3))] end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3399-2262--in--un--go'(V0, V1, V2, V3) -> case V3 of [] -> []; [E0 | E1] -> (fun (V4, V5) -> case ('Idris.Idris2.Prelude.Types':'dn--un--==_Eq_(List $a)'({'Idris.Prelude.EqOrd.MkEq', fun (V6) -> fun (V7) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_String'(V6, V7)) end end, fun (V8) -> fun (V9) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--/=_Eq_String'(V8, V9)) end end}, V0, [V4 | V5])) of 1 -> V1; 0 -> [V4 | ('nested--3399-2262--in--un--go'(V0, V1, V2, V5))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--decEq_DecEq_Namespace'(V0, V1) -> ('with--decEq-2537'(V0, V1, ('Idris.Idris2.Decidable.Equality':'dn--un--decEq_DecEq_(List $a)'(fun (V2) -> fun (V3) -> ('Idris.Idris2.Decidable.Equality':'dn--un--decEq_DecEq_String'(V2, V3)) end end, V0, V1)))).
...
'un--replace'(V0, V1, V2) -> ('nested--3399-2262--in--un--go'(V0, V1, V2, V2)).
...
'un--allParents'(V0) -> ('nested--3471-2329--in--un--go'(V0, V0)).
