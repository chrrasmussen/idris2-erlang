...
-export([
  'case--diffBy-2820'/5,
  'case--splitAfter-2613'/3,
  'nested--2975-2999--in--un--go'/5,
  'un--zipMaybe'/2,
  'un--splitAfter'/2,
  'un--sortedNub'/2,
  'un--minimum'/2,
...
'un--splitAfter'(V0, V1) -> ('case--splitAfter-2613'(V1, V0, ('un--breakAfter'(V0, V1)))).
...
'un--groupBy'(V0, V1) -> case V1 of [] -> []; [E0 | E1] -> (fun (V2, V3) -> case ('nested--2975-2999--in--un--go'(V2, V3, V0, V2, V3)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V4, V5) -> [V4 | V5] end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--diffBy'(V0, V1, V2) -> case V1 of [] -> []; [E0 | E1] -> (fun (V3, V4) -> ('case--diffBy-2820'(V3, V4, V2, V0, ('un--findBy\x{27}'((V0(V3)), V2)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
