...
-export([
  'with--index-3701'/3,
  'with--with block in takeLast-3671'/4,
  'with--takeLast-3669'/3,
  'case--lines\x{27}-3729'/2,
  'un--unlines\x{27}'/1,
  'un--unlines'/1,
  'un--takeLast'/2,
  'un--take'/2,
...
'with--index-3701'(V0, V1, V2) -> case V1 of [] -> {'Idris.Prelude.Types.Nothing'}; [E0 | E1] -> (fun (V3, V4) -> case V2 of 0 -> {'Idris.Prelude.Types.Just', V3}; _ -> begin (V5 = (V2 - 1)), ('with--index-3701'(V0, V4, V5)) end end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--with block in takeLast-3671'(V0, V1, V2, V3) -> case V2 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V4) -> ('Idris.Idris2.Prelude.Types':'un--substr'(('Idris.Idris2.Prelude.Types':'un--minus'(V1, V0)), V1, V3)) end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V5) -> V3 end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--takeLast-3669'(V0, V1, V2) -> ('with--with block in takeLast-3671'(V2, V1, ('Idris.Idris2.Data.Nat':'un--isLTE'(V2, V1)), V0)).
'case--lines\x{27}-3729'(V0, V1) -> case V1 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V2, V3) -> {'Idris.Data.List1.:::', V2, case V3 of [] -> []; [E2 | E3] -> (fun (V4, V5) -> ('Idris.Idris2.Data.List1':'un--forget'(('un--lines\x{27}'(V5)))) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--takeLast'(V0, V1) -> ('with--takeLast-3669'(V1, ('Idris.Idris2.Prelude.Types.String':'un--length'(V1)), V0)).
...
'un--lines\x{27}'(V0) -> case V0 of [] -> ('Idris.Idris2.Data.List1':'un--singleton'([])); _ -> ('case--lines\x{27}-3729'(V0, ('Idris.Idris2.Data.List':'un--break'(fun (V1) -> ('Idris.Idris2.Prelude.Types':'un--isNL'(V1)) end, V0)))) end.
...
'un--index'(V0, V1) -> ('with--index-3701'(V1, ('Idris.Idris2.Prelude.Types':'un--fastUnpack'(V1)), V0)).
