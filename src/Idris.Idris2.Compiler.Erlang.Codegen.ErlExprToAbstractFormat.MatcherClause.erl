...
'rf--preComputedValues'(V0) -> case V0 of {'Idris.Compiler.Erlang.Codegen.ErlExprToAbstractFormat.MkMatcherClause', E0, E1, E2, E3} -> (fun (V1, V2, V3, V4) -> V4 end(E0, E1, E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--pattern'(V0) -> case V0 of {'Idris.Compiler.Erlang.Codegen.ErlExprToAbstractFormat.MkMatcherClause', E0, E1, E2, E3} -> (fun (V1, V2, V3, V4) -> V1 end(E0, E1, E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--guard'(V0) -> case V0 of {'Idris.Compiler.Erlang.Codegen.ErlExprToAbstractFormat.MkMatcherClause', E0, E1, E2, E3} -> (fun (V1, V2, V3, V4) -> V2 end(E0, E1, E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--body'(V0) -> case V0 of {'Idris.Compiler.Erlang.Codegen.ErlExprToAbstractFormat.MkMatcherClause', E0, E1, E2, E3} -> (fun (V1, V2, V3, V4) -> V3 end(E0, E1, E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
