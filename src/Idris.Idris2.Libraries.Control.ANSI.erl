...
'dn--un--__Impl_Show_DecoratedString'() -> {'Idris.Prelude.Show.dn--un--__mkShow', fun (V0) -> ('dn--un--show_Show_DecoratedString'(V0)) end, fun (V1) -> fun (V2) -> ('dn--un--showPrec_Show_DecoratedString'(V1, V2)) end end}.
'un--underline'(V0) -> {'Idris.Libraries.Control.ANSI.MkDString', [{'Idris.Libraries.Control.ANSI.SGR.SetStyle', {'Idris.Libraries.Control.ANSI.SGR.SingleUnderline'}} | []], V0}.
'un--italicize'(V0) -> {'Idris.Libraries.Control.ANSI.MkDString', [{'Idris.Libraries.Control.ANSI.SGR.SetStyle', {'Idris.Libraries.Control.ANSI.SGR.Italic'}} | []], V0}.
'un--colored'(V0, V1) -> {'Idris.Libraries.Control.ANSI.MkDString', [{'Idris.Libraries.Control.ANSI.SGR.SetForeground', V0} | []], V1}.
'un--bolden'(V0) -> {'Idris.Libraries.Control.ANSI.MkDString', [{'Idris.Libraries.Control.ANSI.SGR.SetStyle', {'Idris.Libraries.Control.ANSI.SGR.Bold'}} | []], V0}.
