...
'un--soOr'(V0, V1) -> ('with--soOr-708'(V0, ('un--choose'(V0)), 'erased', V1)).
'un--soNotToNotSo'(V0, V1) -> ('Idris.Idris2.Prelude.Basics':'un--flip'(fun (V2) -> fun (V3) -> ('un--soToNotSoNot'(V2, V3)) end end, V0, V1)).
'un--soAnd'(V0, V1) -> ('with--soAnd-658'(V0, ('un--choose'(V0)), 'erased', V1)).
