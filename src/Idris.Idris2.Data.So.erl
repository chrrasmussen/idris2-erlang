...
'un--soToNotSoNot'(V0, V1) -> case V1 of {'Idris.Data.So.Oh'} -> (fun () -> fun (V2) -> ('dn--un--uninhabited_Uninhabited_(So False)'(V2)) end end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'un--soToEq'(V0, V1) -> case V1 of {'Idris.Data.So.Oh'} -> (fun () -> {'Idris.Builtin.Refl'} end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'un--soOr'(V0, V1, V2) -> ('with--soOr-648'(V1, ('un--choose'(V1)), 'erased', V2)).
...
'un--soAnd'(V0, V1, V2) -> ('with--soAnd-598'(V1, ('un--choose'(V1)), 'erased', V2)).
