...
'rf--maxSize'(V0, V1) -> case V1 of {'Idris.Erlang.Data.IOArray.MkIOArray', E0, E1} -> (fun (V2, V3) -> V2 end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--content'(V0, V1) -> case V1 of {'Idris.Erlang.Data.IOArray.MkIOArray', E0, E1} -> (fun (V2, V3) -> V3 end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
