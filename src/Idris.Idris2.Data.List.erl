...
-export([
  'with--inBounds-650'/5,
  'case--groupBy-3458'/4,
  'case--case block in groupBy,go-3394'/9,
  'case--groupBy,go-3368'/7,
  'case--mapMaybe-2946'/4,
  'case--case block in unzipWith3-2402'/7,
  'case--unzipWith3-2365'/4,
  'case--case block in unzipWith-2294'/6,
  'case--unzipWith-2264'/4,
  'case--replaceWhen-1797'/5,
  'case--tails-1752'/1,
  'case--inits-1723'/1,
  'case--case block in partition-1670'/6,
  'case--partition-1652'/4,
  'case--splitAt-1606'/4,
  'case--split-1540'/3,
  'case--case block in span-1476'/4,
  'case--span-1459'/4,
  'case--case block in spanBy-1410'/5,
  'case--spanBy-1367'/4,
  'case--deleteBy-1257'/5,
  'case--nubBy,nubBy\x{27}-1185'/5,
  'case--lookupBy-1078'/6,
  'case--find-1021'/4,
  'case--filter-976'/4,
  'case--dropWhile-933'/4,
  'case--takeWhile-889'/4,
  'case--unfoldr-815'/3,
  'case--iterate-777'/3,
  'case--with block in inBounds-674'/5,
  'nested--5333-3305--in--un--spreadHeads'/4,
  'nested--5162-3128--in--un--splitRec'/5,
  'nested--5162-3129--in--un--split'/3,
  'nested--3141-1166--in--un--nubBy\x{27}'/3,
  'nested--5377-3350--in--un--go'/5,
...
'with--inBounds-650'(V0, V1, V2, V3, V4) -> case V3 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V5) -> {'Idris.Prelude.Types.Yes', {'Idris.Data.List.InLater', V5}} end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V6) -> {'Idris.Prelude.Types.No', fun (V7) -> case V7 of {'Idris.Data.List.InLater', E2} -> (fun (V8) -> (V6(V8)) end(E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--groupBy-3458'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> [V4 | V5] end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in groupBy,go-3394'(V0, V1, V2, V3, V4, V5, V6, V7, V8) -> case V8 of 1 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--cons'(V3, V6)), V7}; 0 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--singleton'(V3)), [V6 | V7]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--groupBy,go-3368'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V7, V8) -> case ((V2(V5))(V3)) of 1 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--cons'(V5, V7)), V8}; 0 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--singleton'(V5)), [V7 | V8]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--mapMaybe-2946'(V0, V1, V2, V3) -> case V3 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> ('un--mapMaybe'(V2, V1)) end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V4) -> [V4 | ('un--mapMaybe'(V2, V1))] end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in unzipWith3-2402'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V7, V8) -> case V8 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V9, V10) -> {'Idris.Builtin.MkPair', [V3 | V7], {'Idris.Builtin.MkPair', [V4 | V9], [V5 | V10]}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzipWith3-2365'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> case ('dn--un--unzipWith3_Zippable_List'(V2, V1)) of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V8, V9) -> case V9 of {'Idris.Builtin.MkPair', E6, E7} -> (fun (V10, V11) -> {'Idris.Builtin.MkPair', [V4 | V8], {'Idris.Builtin.MkPair', [V6 | V10], [V7 | V11]}} end(E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in unzipWith-2294'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', [V3 | V6], [V4 | V7]} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzipWith-2264'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case ('dn--un--unzipWith_Zippable_List'(V2, V1)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V6, V7) -> {'Idris.Builtin.MkPair', [V4 | V6], [V5 | V7]} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--replaceWhen-1797'(V0, V1, V2, V3, V4) -> case V4 of 1 -> V0; 0 -> V3; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--tails-1752'(V0) -> case V0 of [] -> []; [E0 | E1] -> (fun (V1, V2) -> ('un--tails'(V2)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--inits-1723'(V0) -> case V0 of [] -> []; [E0 | E1] -> (fun (V1, V2) -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_List'(fun (V3) -> [V1 | V3] end, ('un--inits'(V2)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in partition-1670'(V0, V1, V2, V3, V4, V5) -> case V5 of 1 -> {'Idris.Builtin.MkPair', [V2 | V3], V4}; 0 -> {'Idris.Builtin.MkPair', V3, [V2 | V4]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--partition-1652'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case (V2(V0)) of 1 -> {'Idris.Builtin.MkPair', [V0 | V4], V5}; 0 -> {'Idris.Builtin.MkPair', V4, [V0 | V5]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--splitAt-1606'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', [V1 | V4], V5} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--split-1540'(V0, V1, V2) -> case V2 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V3, V4) -> case V4 of [] -> ('Idris.Idris2.Data.List1':'un--singleton'(V3)); [E2 | E3] -> (fun (V5, V6) -> {'Idris.Data.List1.:::', V3, ('Idris.Idris2.Data.List1':'un--forget'(('un--split'(V1, V6))))} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in span-1476'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', [V2 | V4], V5} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--span-1459'(V0, V1, V2, V3) -> case V3 of 1 -> case ('un--span'(V2, V1)) of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', [V0 | V4], V5} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end; 0 -> {'Idris.Builtin.MkPair', [], [V0 | V1]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in spanBy-1410'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', [V3 | V5], V6} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--spanBy-1367'(V0, V1, V2, V3) -> case V3 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> {'Idris.Builtin.MkPair', [], [V0 | V1]} end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V4) -> case ('un--spanBy'(V2, V1)) of {'Idris.Builtin.MkPair', E1, E2} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', [V4 | V5], V6} end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--deleteBy-1257'(V0, V1, V2, V3, V4) -> case V4 of 1 -> V2; 0 -> [V1 | ('un--deleteBy'(V3, V0, V2))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--nubBy,nubBy\x{27}-1185'(V0, V1, V2, V3, V4) -> case V4 of 1 -> ('nested--3141-1166--in--un--nubBy\x{27}'(V3, V2, V1)); 0 -> [V0 | ('nested--3141-1166--in--un--nubBy\x{27}'([V0 | V3], V2, V1))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--lookupBy-1078'(V0, V1, V2, V3, V4, V5) -> case V5 of 1 -> {'Idris.Prelude.Types.Just', V2}; 0 -> ('un--lookupBy'(V4, V0, V3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--find-1021'(V0, V1, V2, V3) -> case V3 of 1 -> {'Idris.Prelude.Types.Just', V0}; 0 -> ('un--find'(V2, V1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--filter-976'(V0, V1, V2, V3) -> case V3 of 1 -> [V0 | ('un--filter'(V2, V1))]; 0 -> ('un--filter'(V2, V1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--dropWhile-933'(V0, V1, V2, V3) -> case V3 of 1 -> ('un--dropWhile'(V2, V1)); 0 -> [V0 | V1]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--takeWhile-889'(V0, V1, V2, V3) -> case V3 of 1 -> [V0 | ('un--takeWhile'(V2, V1))]; 0 -> []; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unfoldr-815'(V0, V1, V2) -> case V2 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> [] end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V3) -> case V3 of {'Idris.Builtin.MkPair', E1, E2} -> (fun (V4, V5) -> [V4 | ('un--unfoldr'(V1, V5))] end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--iterate-777'(V0, V1, V2) -> case V2 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> [] end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V3) -> ('un--iterate'(V1, V3)) end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--with block in inBounds-674'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Data.List.InLater', E0} -> (fun (V5) -> (V2(V5)) end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--5333-3305--in--un--spreadHeads'(V0, V1, V2, V3) -> case V2 of [] -> V3; [E0 | E1] -> (fun (V4, V5) -> case V3 of [] -> [[V4 | []] | ('nested--5333-3305--in--un--spreadHeads'(V0, V1, V5, []))]; [E2 | E3] -> (fun (V6, V7) -> [[V4 | V6] | ('nested--5333-3305--in--un--spreadHeads'(V0, V1, V5, V7))] end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--5162-3128--in--un--splitRec'(V0, V1, V2, V3, V4) -> case V2 of [E0 | E1] -> (fun (V5, V6) -> case V6 of [E2 | E3] -> (fun (V7, V8) -> case V3 of [E4 | E5] -> (fun (V9, V10) -> ('nested--5162-3128--in--un--splitRec'(V0, V1, V8, V10, fun (V11) -> (V4([V9 | V11])) end)) end(E4, E5)); _ -> {'Idris.Builtin.MkPair', V3, (V4([]))} end end(E2, E3)); _ -> {'Idris.Builtin.MkPair', V3, (V4([]))} end end(E0, E1)); _ -> {'Idris.Builtin.MkPair', V3, (V4([]))} end.
'nested--5162-3129--in--un--split'(V0, V1, V2) -> ('nested--5162-3128--in--un--splitRec'(V0, V1, V2, V2, fun (V3) -> V3 end)).
'nested--3141-1166--in--un--nubBy\x{27}'(V0, V1, V2) -> case V2 of [] -> []; [E0 | E1] -> (fun (V3, V4) -> case ('un--elemBy'(V1, V3, V0)) of 1 -> ('nested--3141-1166--in--un--nubBy\x{27}'(V0, V1, V4)); 0 -> [V3 | ('nested--3141-1166--in--un--nubBy\x{27}'([V3 | V0], V1, V4))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--5377-3350--in--un--go'(V0, V1, V2, V3, V4) -> case V4 of [] -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--singleton'(V3)), []}; [E0 | E1] -> (fun (V5, V6) -> case ('nested--5377-3350--in--un--go'(V0, V1, V2, V5, V6)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V7, V8) -> case ((V2(V3))(V5)) of 1 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--cons'(V3, V7)), V8}; 0 -> {'Idris.Builtin.MkPair', ('Idris.Idris2.Data.List1':'un--singleton'(V3)), [V7 | V8]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--transpose'(V0) -> case V0 of [] -> []; [E0 | E1] -> (fun (V1, V2) -> ('nested--5333-3305--in--un--spreadHeads'(V1, V2, V1, ('un--transpose'(V2)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--sortBy'(V0, V1) -> case V1 of [] -> []; [E2 | E3] -> (fun (V2, V3) -> case V3 of [] -> [V2 | []]; _ -> case ('nested--5162-3129--in--un--split'(V1, V0, V1)) of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V4, V5) -> ('un--mergeBy'(V0, ('un--sortBy'(V0, V4)), ('un--sortBy'(V0, V5)))) end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E2, E3)); _ -> case ('nested--5162-3129--in--un--split'(V1, V0, V1)) of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V6, V7) -> ('un--mergeBy'(V0, ('un--sortBy'(V0, V6)), ('un--sortBy'(V0, V7)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end.
...
'un--nubBy'(V0, V1) -> ('nested--3141-1166--in--un--nubBy\x{27}'([], V0, V1)).
...
'un--index\x{27}'(V0, V1) -> case V0 of [E0 | E1] -> (fun (V2, V3) -> case V1 of {'Idris.Data.Fin.FZ'} -> (fun () -> V2 end()); {'Idris.Data.Fin.FS', E2} -> (fun (V4) -> ('un--index\x{27}'(V3, V4)) end(E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--inBounds'(V0, V1) -> case V1 of [] -> {'Idris.Prelude.Types.No', fun (V2) -> ('dn--un--uninhabited_Uninhabited_((InBounds $k) Nil)'(V2)) end}; _ -> case V0 of 0 -> case V1 of [E2 | E3] -> (fun (V3, V4) -> {'Idris.Prelude.Types.Yes', {'Idris.Data.List.InFirst'}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end; _ -> begin (V5 = (V0 - 1)), case V1 of [E0 | E1] -> (fun (V6, V7) -> ('with--inBounds-650'('erased', V5, V7, ('un--inBounds'(V5, V7)), V6)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end.
...
'un--groupBy'(V0, V1) -> case V1 of [] -> []; [E0 | E1] -> (fun (V2, V3) -> case ('nested--5377-3350--in--un--go'(V2, V3, V0, V2, V3)) of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V4, V5) -> [V4 | V5] end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
