...
-export([
  'with--clockTime-774'/3,
  'with--clockTimeReturnType-771'/2,
  'case--with block in clockTime-811'/4,
  'case--compare-531'/6,
  'case--max-472'/3,
  'case--min-451'/3,
...
'with--clockTime-774'(V0, V1, V2) -> case V1 of 0 -> begin (V3 = ('un--fetchOSClock'(V0, V2))), ('un--fromOSClock'(V0, V3, V2)) end; 1 -> begin (V4 = ('un--fetchOSClock'(V0, V2))), begin (V7 = ('Idris.Idris2.Prelude.IO':'dn--un--map_Functor_IO'(fun (V5) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Int'(V5, 1)) end, fun (V6) -> ('un--osClockValid'(V4, V6)) end, V2))), case V7 of 1 -> ('Idris.Idris2.Prelude.IO':'dn--un--map_Functor_IO'(fun (V8) -> {'Idris.Prelude.Types.Just', V8} end, fun (V9) -> ('un--fromOSClock'(V0, V4, V9)) end, V2)); 0 -> {'Idris.Prelude.Types.Nothing'}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--clockTimeReturnType-771'(V0, V1) -> case V1 of 1 -> {'Idris.Prelude.Types.Maybe', {'Idris.System.Clock.Clock', V0}}; 0 -> {'Idris.System.Clock.Clock', V0}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--with block in clockTime-811'(V0, V1, V2, V3) -> case V2 of 1 -> ('Idris.Idris2.Prelude.IO':'dn--un--map_Functor_IO'(fun (V4) -> {'Idris.Prelude.Types.Just', V4} end, fun (V5) -> ('un--fromOSClock'(V0, V1, V5)) end, V3)); 0 -> {'Idris.Prelude.Types.Nothing'}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--compare-531'(V0, V1, V2, V3, V4, V5) -> case V5 of 0 -> 0; 2 -> 2; 1 -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--compare_Ord_Integer'(V1, V3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--max-472'(V0, V1, V2) -> case V2 of 1 -> V1; 0 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--min-451'(V0, V1, V2) -> case V2 of 1 -> V1; 0 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--timeDifference'(V0, V1) -> ('un--fromNano'(2, ('Idris.Idris2.Prelude.Num':'dn--un---_Neg_Integer'(('un--toNano'(V0)), ('un--toNano'(V1)))))).
'un--subtractDuration'(V0, V1, V2) -> ('un--fromNano'(V0, ('Idris.Idris2.Prelude.Num':'dn--un---_Neg_Integer'(('un--toNano'(V1)), ('un--toNano'(V2)))))).
...
'un--clockTimeReturnType'(V0) -> ('with--clockTimeReturnType-771'(V0, ('un--isClockMandatory'(V0)))).
...
'un--clockTime'(V0, V1) -> ('with--clockTime-774'(V0, ('un--isClockMandatory'(V0)), V1)).
