-module('Idris.Idris2.Libraries.Utils.Either').
-compile('no_auto_import').
-compile('inline').
-compile({'inline_size',24}).
-export([
  'case--partitionEithers-452'/5,
  'case--partitionEithers-414'/5,
  'un--partitionEithers'/3,
  'un--mapError'/5
]).
'case--partitionEithers-452'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', V5, [V2 | V6]} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--partitionEithers-414'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', [V2 | V5], V6} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
