...
'dn--un--top_Top_ZeroOneOmega'() -> {'Idris.Algebra.ZeroOneOmega.RigW'}.
'dn--un--topAbs_Top_ZeroOneOmega'(V0) -> case V0 of {'Idris.Algebra.ZeroOneOmega.Rig0'} -> (fun () -> {'Idris.Builtin.Refl'} end()); {'Idris.Algebra.ZeroOneOmega.Rig1'} -> (fun () -> {'Idris.Builtin.Refl'} end()); {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> {'Idris.Builtin.Refl'} end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--timesNeutral_Semiring_ZeroOneOmega'() -> {'Idris.Algebra.ZeroOneOmega.Rig1'}.
'dn--un--show_Show_ZeroOneOmega'(V0) -> case V0 of {'Idris.Algebra.ZeroOneOmega.Rig0'} -> (fun () -> <<"Rig0"/utf8>> end()); {'Idris.Algebra.ZeroOneOmega.Rig1'} -> (fun () -> <<"Rig1"/utf8>> end()); {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> <<"RigW"/utf8>> end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--showPrec_Show_ZeroOneOmega'(V0, V1) -> ('dn--un--show_Show_ZeroOneOmega'(V1)).
'dn--un--preorderTrans_Preorder_ZeroOneOmega'(V0, V1, V2, V3, V4) -> case V0 of {'Idris.Algebra.ZeroOneOmega.Rig0'} -> (fun () -> {'Idris.Builtin.Refl'} end()); {'Idris.Algebra.ZeroOneOmega.Rig1'} -> (fun () -> case V2 of {'Idris.Algebra.ZeroOneOmega.Rig1'} -> (fun () -> {'Idris.Builtin.Refl'} end()); {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> {'Idris.Builtin.Refl'} end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end()); {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> case V1 of {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> V4 end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--preorderRefl_Preorder_ZeroOneOmega'(V0) -> case V0 of {'Idris.Algebra.ZeroOneOmega.Rig0'} -> (fun () -> {'Idris.Builtin.Refl'} end()); {'Idris.Algebra.ZeroOneOmega.Rig1'} -> (fun () -> {'Idris.Builtin.Refl'} end()); {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> {'Idris.Builtin.Refl'} end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--plusNeutral_Semiring_ZeroOneOmega'() -> {'Idris.Algebra.ZeroOneOmega.Rig0'}.
...
'dn--un--__Impl_Show_ZeroOneOmega'() -> {'Idris.Prelude.Show.dn--un--__mkShow', fun (V0) -> ('dn--un--show_Show_ZeroOneOmega'(V0)) end, fun (V1) -> fun (V2) -> ('dn--un--showPrec_Show_ZeroOneOmega'(V1, V2)) end end}.
...
'dn--un--__Impl_Eq_ZeroOneOmega'() -> {'Idris.Prelude.EqOrd.dn--un--__mkEq', fun (V0) -> fun (V1) -> ('dn--un--==_Eq_ZeroOneOmega'(V0, V1)) end end, fun (V2) -> fun (V3) -> ('dn--un--/=_Eq_ZeroOneOmega'(V2, V3)) end end}.
'dn--un--==_Eq_ZeroOneOmega'(V0, V1) -> case V0 of {'Idris.Algebra.ZeroOneOmega.Rig0'} -> (fun () -> case V1 of {'Idris.Algebra.ZeroOneOmega.Rig0'} -> (fun () -> 0 end()); _ -> 1 end end()); {'Idris.Algebra.ZeroOneOmega.Rig1'} -> (fun () -> case V1 of {'Idris.Algebra.ZeroOneOmega.Rig1'} -> (fun () -> 0 end()); _ -> 1 end end()); {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> case V1 of {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> 0 end()); _ -> 1 end end()); _ -> 1 end.
'dn--un--<=_Preorder_ZeroOneOmega'(V0, V1) -> case V0 of {'Idris.Algebra.ZeroOneOmega.Rig0'} -> (fun () -> 0 end()); {'Idris.Algebra.ZeroOneOmega.Rig1'} -> (fun () -> case V1 of {'Idris.Algebra.ZeroOneOmega.Rig1'} -> (fun () -> 0 end()); {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> 0 end()); _ -> 1 end end()); {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> case V1 of {'Idris.Algebra.ZeroOneOmega.RigW'} -> (fun () -> 0 end()); _ -> 1 end end()); _ -> 1 end.
'dn--un--/=_Eq_ZeroOneOmega'(V0, V1) -> ('Idris.Idris2.Prelude.Basics':'un--not'(('dn--un--==_Eq_ZeroOneOmega'(V0, V1)))).
