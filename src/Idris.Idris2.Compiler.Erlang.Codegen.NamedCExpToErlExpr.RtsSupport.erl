...
-export([
  'nested--5015-4068--in--un--genHalt'/5,
  'nested--4917-3977--in--un--curry'/10,
  'un--newLocalVars'/2,
  'un--newLocalVar'/2,
  'un--integerPower'/2,
  'un--genValidChar'/2,
...
'nested--5015-4068--in--un--genHalt'(V0, V1, V2, V3, V4) -> ('un--genFunCall'(V3, <<"erlang"/utf8>>, <<"halt"/utf8>>, [{'Idris.Compiler.Erlang.IR.ErlExpr.EInteger', V3, V4} | []])).
'nested--4917-3977--in--un--curry'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) -> case V6 of 0 -> fun (V10) -> {'Idris.Prelude.Types.Right', (V7({'Idris.Compiler.Erlang.IR.ErlExpr.EApp', V5, V8, ('Idris.Idris2.Data.List':'un--reverse'(V9))}))} end; _ -> begin (V11 = (V6 - 1)), fun (V12) -> begin (V13 = ('un--newLocalVar'(V4, V12))), case V13 of {'Idris.Prelude.Types.Left', E0} -> (fun (V14) -> {'Idris.Prelude.Types.Left', V14} end(E0)); {'Idris.Prelude.Types.Right', E1} -> (fun (V15) -> begin (V16 = (('nested--4917-3977--in--un--curry'(V0, V1, V2, V3, V4, V5, V11, V7, V8, [{'Idris.Compiler.Erlang.IR.ErlExpr.ELocal', V5, V15} | V9]))(V12))), case V16 of {'Idris.Prelude.Types.Left', E2} -> (fun (V17) -> {'Idris.Prelude.Types.Left', V17} end(E2)); {'Idris.Prelude.Types.Right', E3} -> (fun (V18) -> {'Idris.Prelude.Types.Right', {'Idris.Compiler.Erlang.IR.ErlExpr.ELam', V5, [V15 | []], V18}} end(E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end end.
...
'un--genCurry'(V0, V1, V2, V3, V4) -> ('nested--4917-3977--in--un--curry'(V4, V3, V2, V1, V0, V1, V2, V3, V4, [])).
