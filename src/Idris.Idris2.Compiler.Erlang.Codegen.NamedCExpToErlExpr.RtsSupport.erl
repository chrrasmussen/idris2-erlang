...
-export([
  'case--case block in genRef-1289'/6,
  'case--genRef-1275'/4,
  'case--case block in addLocalVars-1177'/8,
  'case--addLocalVars-1155'/5,
  'case--newLocalVar-1072'/2,
  'nested--5961-1500--in--un--genHalt'/5,
  'nested--5865-1410--in--un--curry'/10,
  'un--newLocalVars'/2,
  'un--newLocalVar'/2,
  'un--integerPower'/2,
  'un--genValidChar'/2,
...
'case--case block in genRef-1289'(V0, V1, V2, V3, V4, V5) -> case V5 of 0 -> {'Idris.Compiler.Erlang.IR.ErlExpr.EAtom', V1, V4}; 1 -> {'Idris.Compiler.Erlang.IR.ErlExpr.ERef', V1, {'Idris.Compiler.Erlang.IR.ErlExpr.EAtom', V1, V3}, {'Idris.Compiler.Erlang.IR.ErlExpr.EAtom', V1, V4}}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--genRef-1275'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> ('case--case block in genRef-1289'(V0, V1, V2, V4, V5, ('Idris.Idris2.Compiler.Erlang.Name':'un--isNameInCurrentModule'(V2, V0)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in addLocalVars-1177'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V7 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V8, V9) -> fun (V10) -> {'Idris.Prelude.Types.Right', {'Idris.Builtin.MkPair', V8, [V5 | V9]}} end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--addLocalVars-1155'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> fun (V7) -> begin (V8 = (('un--addLocalVars'(V3, V1, V5))(V7))), case V8 of {'Idris.Prelude.Types.Left', E2} -> (fun (V9) -> {'Idris.Prelude.Types.Left', V9} end(E2)); {'Idris.Prelude.Types.Right', E3} -> (fun (V10) -> case V10 of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V11, V12) -> {'Idris.Prelude.Types.Right', {'Idris.Builtin.MkPair', V11, [V6 | V12]}} end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--newLocalVar-1072'(V0, V1) -> case V1 of {'Idris.Compiler.Erlang.IR.ErlExpr.LocalVars.MkLocalVars', E0, E1} -> (fun (V2, V3) -> fun (V4) -> begin (V6 = begin (V5 = ('erlang':'put'(V0, {'Idris.Compiler.Erlang.IR.ErlExpr.LocalVars.MkLocalVars', V2, ((V3 + 1) rem 9223372036854775808)}))), {'Idris.Prelude.Types.Right', V5} end), case V6 of {'Idris.Prelude.Types.Left', E2} -> (fun (V7) -> {'Idris.Prelude.Types.Left', V7} end(E2)); {'Idris.Prelude.Types.Right', E3} -> (fun (V8) -> {'Idris.Prelude.Types.Right', {'Idris.Compiler.Erlang.IR.ErlExpr.LocalVars.MkLocalVar', V2, V3}} end(E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--5961-1500--in--un--genHalt'(V0, V1, V2, V3, V4) -> ('un--genFunCall'(V3, <<"erlang"/utf8>>, <<"halt"/utf8>>, [{'Idris.Compiler.Erlang.IR.ErlExpr.EInteger', V3, V4} | []])).
'nested--5865-1410--in--un--curry'(V0, V1, V2, V3, V4, V5, V6, V7, V8, V9) -> case V6 of 0 -> fun (V10) -> {'Idris.Prelude.Types.Right', (V7({'Idris.Compiler.Erlang.IR.ErlExpr.EApp', V5, V8, ('Idris.Idris2.Data.List':'un--reverse'('erased', V9))}))} end; _ -> begin (V11 = (V6 - 1)), fun (V12) -> begin (V13 = ('un--newLocalVar'(V4, V12))), case V13 of {'Idris.Prelude.Types.Left', E0} -> (fun (V14) -> {'Idris.Prelude.Types.Left', V14} end(E0)); {'Idris.Prelude.Types.Right', E1} -> (fun (V15) -> begin (V16 = (('nested--5865-1410--in--un--curry'(V0, V1, V2, V3, V4, V5, V11, V7, V8, [{'Idris.Compiler.Erlang.IR.ErlExpr.ELocal', V5, V15} | V9]))(V12))), case V16 of {'Idris.Prelude.Types.Left', E2} -> (fun (V17) -> {'Idris.Prelude.Types.Left', V17} end(E2)); {'Idris.Prelude.Types.Right', E3} -> (fun (V18) -> {'Idris.Prelude.Types.Right', {'Idris.Compiler.Erlang.IR.ErlExpr.ELam', V5, [V15 | []], V18}} end(E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end end.
...
'un--genUnsafePerformIO'(V0, V1, V2) -> {'Idris.Compiler.Erlang.IR.ErlExpr.EApp', V1, ('un--genRef'(V0, V1, {'Idris.Core.Name.NS', ('Idris.Idris2.Core.Name.Namespace':'un--primIONS'()), {'Idris.Core.Name.UN', <<"unsafePerformIO"/utf8>>}})), [('un--genErased'(V1)) | [V2 | []]]}.
...
'un--genRef'(V0, V1, V2) -> ('case--genRef-1275'(V2, V1, V0, ('Idris.Idris2.Compiler.Erlang.Name':'un--moduleNameFunctionName'(V0, V2)))).
...
'un--genList'(V0, V1) -> ('Idris.Idris2.Prelude.Types':'dn--un--foldr_Foldable_List'('erased', 'erased', fun (V2) -> fun (V3) -> {'Idris.Compiler.Erlang.IR.ErlExpr.ECons', V0, V2, V3} end end, {'Idris.Compiler.Erlang.IR.ErlExpr.ENil', V0}, V1)).
...
'un--genErlMain'(V0, V1, V2) -> begin (V3 = ('un--genFunCall'(V1, <<"erlang"/utf8>>, <<"process_flag"/utf8>>, [{'Idris.Compiler.Erlang.IR.ErlExpr.EAtom', V1, <<"trap_exit"/utf8>>} | [{'Idris.Compiler.Erlang.IR.ErlExpr.EAtom', V1, <<"false"/utf8>>} | []]]))), fun (V4) -> begin (V5 = ('un--newLocalVar'(V0, V4))), case V5 of {'Idris.Prelude.Types.Left', E0} -> (fun (V6) -> {'Idris.Prelude.Types.Left', V6} end(E0)); {'Idris.Prelude.Types.Right', E1} -> (fun (V7) -> begin (V8 = ('un--newLocalVar'(V0, V4))), case V8 of {'Idris.Prelude.Types.Left', E2} -> (fun (V9) -> {'Idris.Prelude.Types.Left', V9} end(E2)); {'Idris.Prelude.Types.Right', E3} -> (fun (V10) -> begin (V11 = {'Idris.Compiler.Erlang.IR.ErlExpr.ESequence', V1, {'Idris.Data.Vect.::', V3, {'Idris.Data.Vect.::', ('un--genEscriptMain'(V1, V2)), {'Idris.Data.Vect.::', ('nested--5961-1500--in--un--genHalt'(V2, V1, V0, V1, 0)), {'Idris.Data.Vect.Nil'}}}}}), {'Idris.Prelude.Types.Right', {'Idris.Compiler.Erlang.IR.ErlExpr.ETryCatch', V1, V11, V7, {'Idris.Compiler.Erlang.IR.ErlExpr.ELocal', V1, V7}, V10, {'Idris.Compiler.Erlang.IR.ErlExpr.ESequence', V1, {'Idris.Data.Vect.::', ('un--genFunCall'(V1, <<"erlang"/utf8>>, <<"display"/utf8>>, [{'Idris.Compiler.Erlang.IR.ErlExpr.ELocal', V1, V10} | []])), {'Idris.Data.Vect.::', ('nested--5961-1500--in--un--genHalt'(V2, V1, V0, V1, 127)), {'Idris.Data.Vect.Nil'}}}}}} end end(E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end.
'un--genErased'(V0) -> {'Idris.Compiler.Erlang.IR.ErlExpr.EAtom', V0, <<"erased"/utf8>>}.
...
'un--genCurry'(V0, V1, V2, V3, V4) -> ('nested--5865-1410--in--un--curry'(V4, V3, V2, V1, V0, V1, V2, V3, V4, [])).
...
'un--addLocalVars'(V0, V1, V2) -> case V1 of [] -> fun (V3) -> {'Idris.Prelude.Types.Right', {'Idris.Builtin.MkPair', V2, []}} end; [E0 | E1] -> (fun (V4, V5) -> fun (V6) -> begin (V7 = ('un--addLocalVar'(V0, V4, V2, V6))), case V7 of {'Idris.Prelude.Types.Left', E2} -> (fun (V8) -> {'Idris.Prelude.Types.Left', V8} end(E2)); {'Idris.Prelude.Types.Right', E3} -> (fun (V9) -> case V9 of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V10, V11) -> begin (V12 = (('un--addLocalVars'(V0, V5, V10))(V6))), case V12 of {'Idris.Prelude.Types.Left', E6} -> (fun (V13) -> {'Idris.Prelude.Types.Left', V13} end(E6)); {'Idris.Prelude.Types.Right', E7} -> (fun (V14) -> case V14 of {'Idris.Builtin.MkPair', E8, E9} -> (fun (V15, V16) -> {'Idris.Prelude.Types.Right', {'Idris.Builtin.MkPair', V15, [V11 | V16]}} end(E8, E9)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'un--addLocalVar'(V0, V1, V2, V3) -> begin (V4 = ('un--newLocalVar'(V0, V3))), case V4 of {'Idris.Prelude.Types.Left', E0} -> (fun (V5) -> {'Idris.Prelude.Types.Left', V5} end(E0)); {'Idris.Prelude.Types.Right', E1} -> (fun (V6) -> {'Idris.Prelude.Types.Right', {'Idris.Builtin.MkPair', ('Idris.Idris2.Libraries.Data.NameMap':'un--insert'('erased', V1, V6, V2)), V6}} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end.
