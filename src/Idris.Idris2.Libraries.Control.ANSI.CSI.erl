...
'dn--un--cast_Cast_EraseDirection_String'(V0) -> case V0 of {'Idris.Libraries.Control.ANSI.CSI.Start'} -> (fun () -> <<"1"/utf8>> end()); {'Idris.Libraries.Control.ANSI.CSI.End'} -> (fun () -> <<"0"/utf8>> end()); {'Idris.Libraries.Control.ANSI.CSI.All'} -> (fun () -> <<"2"/utf8>> end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
