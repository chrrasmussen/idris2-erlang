...
-export([
  'case--branchVal-714'/7,
  'case--branchOne-663'/7,
  'case--branchZero-612'/7,
  'case--case block in elimSemi-512'/8,
  'case--elimSemi-462'/8,
  'un--|+|'/2,
  'un--|*|'/2,
  'un--timesNeutral'/2,
...
'case--branchVal-714'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of 0 -> (V5()); 1 -> (V4()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--branchOne-663'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of 0 -> (V5()); 1 -> (V4()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--branchZero-612'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of 0 -> (V5()); 1 -> (V4()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in elimSemi-512'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V7 of 0 -> V5; 1 -> (V4(V3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--elimSemi-462'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V7 of 0 -> V6; 1 -> ('case--case block in elimSemi-512'('erased', 'erased', V2, V3, V4, V5, V6, case ('Idris.Idris2.Builtin':'un--snd'('erased', 'erased', V2)) of {'Idris.Prelude.EqOrd.dn--un--__mkEq', E0, E1} -> (fun (V8, V9) -> ((V8(V3))(case ('Idris.Idris2.Builtin':'un--fst'('erased', 'erased', V2)) of {'Idris.Algebra.Semiring.dn--un--__mkSemiring', E2, E3, E4, E5} -> (fun (V10, V11, V12, V13) -> V13 end(E2, E3, E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--elimSemi'(V0, V1, V2, V3, V4, V5, V6) -> ('case--elimSemi-462'('erased', 'erased', V2, V6, V5, V4, V3, case ('Idris.Idris2.Builtin':'un--snd'('erased', 'erased', V2)) of {'Idris.Prelude.EqOrd.dn--un--__mkEq', E0, E1} -> (fun (V7, V8) -> ((V7(V6))(case ('Idris.Idris2.Builtin':'un--fst'('erased', 'erased', V2)) of {'Idris.Algebra.Semiring.dn--un--__mkSemiring', E2, E3, E4, E5} -> (fun (V9, V10, V11, V12) -> V10 end(E2, E3, E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end)).
'un--branchZero'(V0, V1, V2, V3, V4, V5) -> ('case--branchZero-612'('erased', 'erased', V2, V5, V4, V3, ('un--isErased'('erased', V2, V5)))).
'un--branchVal'(V0, V1, V2, V3, V4, V5) -> ('case--branchVal-714'('erased', 'erased', V2, V5, V4, V3, ('un--isRigOther'('erased', V2, V5)))).
'un--branchOne'(V0, V1, V2, V3, V4, V5) -> ('case--branchOne-663'('erased', 'erased', V2, V5, V4, V3, ('un--isLinear'('erased', V2, V5)))).
