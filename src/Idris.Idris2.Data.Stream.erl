...
-export([
  'case--takeBefore-3204'/4,
  'case--takeUntil-3162'/4,
  'case--unzip3-2825'/2,
  'case--unzip3-2801'/2,
  'case--unzip3-2777'/2,
  'case--unfoldr-2450'/3,
  'nested--3309-3299--in--un--quadrant'/0,
  'nested--3128-3132--in--un--cycle\x{27}'/3,
...
'case--takeBefore-3204'(V0, V1, V2, V3) -> case V3 of 1 -> []; 0 -> [V0 | ('un--takeBefore'(V2, (V1())))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--takeUntil-3162'(V0, V1, V2, V3) -> case V3 of 1 -> [V0 | []]; 0 -> [V0 | ('un--takeUntil'(V2, (V1())))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzip3-2825'(V0, V1) -> case V1 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V4, V5) -> V5 end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzip3-2801'(V0, V1) -> case V1 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V4, V5) -> V4 end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unzip3-2777'(V0, V1) -> case V1 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V4, V5) -> V2 end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--unfoldr-2450'(V0, V1, V2) -> case V2 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V3, V4) -> {'Idris.Prelude.Types.Stream.::', V3, fun () -> ('un--unfoldr'(V1, V4)) end} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3309-3299--in--un--quadrant'() -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_Stream'(fun (V0) -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor_Stream'(fun (V1) -> {'Idris.Builtin.MkPair', V0, V1} end, ('un--nats'()))) end, ('un--nats'()))).
'nested--3128-3132--in--un--cycle\x{27}'(V0, V1, V2) -> case V2 of [] -> {'Idris.Prelude.Types.Stream.::', V0, fun () -> ('nested--3128-3132--in--un--cycle\x{27}'(V0, V1, V1)) end}; [E0 | E1] -> (fun (V3, V4) -> {'Idris.Prelude.Types.Stream.::', V3, fun () -> ('nested--3128-3132--in--un--cycle\x{27}'(V0, V1, V4)) end} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--cycle'(V0) -> case V0 of [E0 | E1] -> (fun (V1, V2) -> {'Idris.Prelude.Types.Stream.::', V1, fun () -> ('nested--3128-3132--in--un--cycle\x{27}'(V1, V2, V2)) end} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
