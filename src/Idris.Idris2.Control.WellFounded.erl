...
-export([
  'nested--2968-987--in--un--acc'/6,
  'dn--un--size_Sized_Nat'/1,
  'dn--un--size_Sized_(List $a)'/2,
  'dn--un--size_Sized_((Pair $a) $b)'/4,
...
'nested--2968-987--in--un--acc'(V0, V1, V2, V3, V4, V5) -> case V3 of 0 -> ('erlang':'throw'("Nat case not covered")); _ -> begin (V6 = (V3 - 1)), case V5 of {'Idris.Data.Nat.LTESucc', E0} -> (fun (V7) -> fun (V8) -> fun (V9) -> ('nested--2968-987--in--un--acc'('erased', V1, V2, V6, V8, ('Idris.Idris2.Data.Nat':'un--lteTransitive'('erased', 'erased', 'erased', V9, V7)))) end end end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end.
'dn--un--size_Sized_Nat'(V0) -> V0.
'dn--un--size_Sized_(List $a)'(V0, V1) -> ('Idris.Idris2.Prelude.Types.List':'un--length'('erased', V1)).
'dn--un--size_Sized_((Pair $a) $b)'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> ('Idris.Idris2.Prelude.Types':'dn--un--+_Num_Nat'((('Idris.Idris2.Builtin':'un--fst'('erased', 'erased', V2))(V4)), (('Idris.Idris2.Builtin':'un--snd'('erased', 'erased', V2))(V5)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--__Impl_Sized_Nat'(V0) -> ('dn--un--size_Sized_Nat'(V0)).
'dn--un--__Impl_Sized_(List $a)'(V0, V1) -> ('dn--un--size_Sized_(List $a)'('erased', V1)).
'dn--un--__Impl_Sized_((Pair $a) $b)'(V0, V1, V2, V3) -> ('dn--un--size_Sized_((Pair $a) $b)'('erased', 'erased', V2, V3)).
...
'un--sizeAccessible'(V0, V1, V2, V3, V4) -> ('nested--2968-987--in--un--acc'('erased', V1, V2, (V1(V2)), V3, V4)).
