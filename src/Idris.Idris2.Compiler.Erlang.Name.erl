...
-export([
  'case--constructorName-1717'/3,
  'case--moduleNameFunctionName-1687'/3,
  'case--isNameInCurrentModule-1664'/3,
  'case--currentModuleName-1651'/2,
  'case--moduleNameForNS-1632'/3,
  'case--max-1489'/3,
  'case--min-1475'/3,
  'case--compare-1348'/5,
...
'case--constructorName-1717'(V0, V1, V2) -> case V2 of {'Idris.Core.Name.UN', E0} -> (fun (V3) -> V3 end(E0)); _ -> ('un--genName'(V2)) end.
'case--moduleNameFunctionName-1687'(V0, V1, V2) -> case V2 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V3) -> {'Idris.Builtin.MkPair', V3, ('un--genName'(V0))} end(E0)); {'Idris.Compiler.Erlang.Name.Split', E1, E2} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', ('un--moduleNameForName'(V1, V0)), ('un--genName'(('Idris.Idris2.Core.Name':'un--dropNS'(V0))))} end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--isNameInCurrentModule-1664'(V0, V1, V2) -> case V2 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V3) -> 0 end(E0)); {'Idris.Compiler.Erlang.Name.Split', E1, E2} -> (fun (V4, V5) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_String'(('un--moduleNameForName'(V1, V0)), ('un--currentModuleName'(V1)))) end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--currentModuleName-1651'(V0, V1) -> case V1 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V2) -> V2 end(E0)); {'Idris.Compiler.Erlang.Name.Split', E1, E2} -> (fun (V3, V4) -> ('un--moduleNameForNS'(V0, V4)) end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--moduleNameForNS-1632'(V0, V1, V2) -> case V2 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V3) -> V3 end(E0)); {'Idris.Compiler.Erlang.Name.Split', E1, E2} -> (fun (V4, V5) -> ('Idris.Idris2.Core.Name.Namespace':'dn--un--show_Show_Namespace'(('Idris.Idris2.Core.Name.Namespace':'un--<.>'(('Idris.Idris2.Core.Name.Namespace':'un--mkNamespace'(V4)), V0)))) end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--max-1489'(V0, V1, V2) -> case V2 of 0 -> V1; 1 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--min-1475'(V0, V1, V2) -> case V2 of 0 -> V1; 1 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--compare-1348'(V0, V1, V2, V3, V4) -> case V4 of 0 -> 0; 2 -> 2; 1 -> ('Idris.Idris2.Core.Name.Namespace':'dn--un--compare_Ord_Namespace'(V0, V2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--min_Ord_NamespaceInfo'(V0, V1) -> ('case--min-1475'(V1, V0, ('dn--un--<_Ord_NamespaceInfo'(V0, V1)))).
'dn--un--max_Ord_NamespaceInfo'(V0, V1) -> ('case--max-1489'(V1, V0, ('dn--un-->_Ord_NamespaceInfo'(V0, V1)))).
'dn--un--compare_Ord_OutputBundle'(V0, V1) -> case V0 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V2) -> case V1 of {'Idris.Compiler.Erlang.Name.Concat', E1} -> (fun (V3) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--compare_Ord_String'(V2, V3)) end(E1)); {'Idris.Compiler.Erlang.Name.Split', E2, E3} -> (fun (V4, V5) -> 0 end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); {'Idris.Compiler.Erlang.Name.Split', E4, E5} -> (fun (V6, V7) -> case V1 of {'Idris.Compiler.Erlang.Name.Split', E6, E7} -> (fun (V8, V9) -> ('case--compare-1348'(V7, V6, V9, V8, ('Idris.Idris2.Prelude.EqOrd':'dn--un--compare_Ord_String'(V6, V8)))) end(E6, E7)); {'Idris.Compiler.Erlang.Name.Concat', E8} -> (fun (V10) -> 2 end(E8)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--compare_Ord_NamespaceInfo'(V0, V1) -> ('dn--un--compare_Ord_OutputBundle'(V0, V1)).
'dn--un--__Impl_Ord_NamespaceInfo'() -> {'Idris.Prelude.EqOrd.dn--un--__mkOrd', {'Idris.Prelude.EqOrd.dn--un--__mkEq', fun (V0) -> fun (V1) -> ('dn--un--==_Eq_NamespaceInfo'(V0, V1)) end end, fun (V2) -> fun (V3) -> ('dn--un--/=_Eq_NamespaceInfo'(V2, V3)) end end}, fun (V4) -> fun (V5) -> ('dn--un--compare_Ord_NamespaceInfo'(V4, V5)) end end, fun (V6) -> fun (V7) -> ('dn--un--<_Ord_NamespaceInfo'(V6, V7)) end end, fun (V8) -> fun (V9) -> ('dn--un-->_Ord_NamespaceInfo'(V8, V9)) end end, fun (V10) -> fun (V11) -> ('dn--un--<=_Ord_NamespaceInfo'(V10, V11)) end end, fun (V12) -> fun (V13) -> ('dn--un-->=_Ord_NamespaceInfo'(V12, V13)) end end, fun (V14) -> fun (V15) -> ('dn--un--max_Ord_NamespaceInfo'(V14, V15)) end end, fun (V16) -> fun (V17) -> ('dn--un--min_Ord_NamespaceInfo'(V16, V17)) end end}.
'dn--un--__Impl_Eq_OutputBundle'() -> {'Idris.Prelude.EqOrd.dn--un--__mkEq', fun (V0) -> fun (V1) -> ('dn--un--==_Eq_OutputBundle'(V0, V1)) end end, fun (V2) -> fun (V3) -> ('dn--un--/=_Eq_OutputBundle'(V2, V3)) end end}.
'dn--un--__Impl_Eq_NamespaceInfo'() -> {'Idris.Prelude.EqOrd.dn--un--__mkEq', fun (V0) -> fun (V1) -> ('dn--un--==_Eq_NamespaceInfo'(V0, V1)) end end, fun (V2) -> fun (V3) -> ('dn--un--/=_Eq_NamespaceInfo'(V2, V3)) end end}.
...
'dn--un--==_Eq_OutputBundle'(V0, V1) -> case V0 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V2) -> case V1 of {'Idris.Compiler.Erlang.Name.Concat', E1} -> (fun (V3) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_String'(V2, V3)) end(E1)); _ -> 1 end end(E0)); {'Idris.Compiler.Erlang.Name.Split', E2, E3} -> (fun (V4, V5) -> case V1 of {'Idris.Compiler.Erlang.Name.Split', E4, E5} -> (fun (V6, V7) -> ('Idris.Idris2.Prelude.Basics':'un--&&'(('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_String'(V4, V6)), fun () -> ('Idris.Idris2.Core.Name.Namespace':'dn--un--==_Eq_Namespace'(V5, V7)) end)) end(E4, E5)); _ -> 1 end end(E2, E3)); _ -> 1 end.
'dn--un--==_Eq_NamespaceInfo'(V0, V1) -> ('dn--un--==_Eq_OutputBundle'(V0, V1)).
'dn--un--<_Ord_NamespaceInfo'(V0, V1) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq_Ordering'(('dn--un--compare_Ord_NamespaceInfo'(V0, V1)), 0)).
'dn--un--<=_Ord_NamespaceInfo'(V0, V1) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--/=_Eq_Ordering'(('dn--un--compare_Ord_NamespaceInfo'(V0, V1)), 2)).
'dn--un--/=_Eq_OutputBundle'(V0, V1) -> ('Idris.Idris2.Prelude.Basics':'un--not'(('dn--un--==_Eq_OutputBundle'(V0, V1)))).
'dn--un--/=_Eq_NamespaceInfo'(V0, V1) -> ('Idris.Idris2.Prelude.Basics':'un--not'(('dn--un--==_Eq_NamespaceInfo'(V0, V1)))).
'un--moduleNameFunctionName'(V0, V1) -> ('case--moduleNameFunctionName-1687'(V1, V0, V0)).
'un--moduleNameForName'(V0, V1) -> ('un--moduleNameForNS'(V0, ('un--getNamespace'(V1)))).
'un--moduleNameForNS'(V0, V1) -> ('case--moduleNameForNS-1632'(V1, V0, V0)).
'un--isNameInCurrentModule'(V0, V1) -> ('case--isNameInCurrentModule-1664'(V1, V0, V0)).
