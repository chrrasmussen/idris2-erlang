...
-export([
  'with--with block in isElem-962'/7,
  'with--isElem-926'/6,
  'with--decEq-759'/8,
  'case--indexElem-1124'/5,
  'dn--un--uninhabited_Uninhabited_(|((=== Here) (There $e)),((~=~ Here) (There $e))|)'/5,
  'dn--un--uninhabited_Uninhabited_(|((=== (There $e)) Here),((~=~ (There $e)) Here)|)'/5,
  'dn--un--uninhabited_Uninhabited_(((Elem [a = $a]) $x) Nil)'/3,
  'dn--un--decEq_DecEq_((Elem $x) $xs)'/5,
  'dn--un--__Impl_Uninhabited_(|((=== Here) (There $e)),((~=~ Here) (There $e))|)'/5,
  'dn--un--__Impl_Uninhabited_(|((=== (There $e)) Here),((~=~ (There $e)) Here)|)'/5,
  'dn--un--__Impl_Uninhabited_(((Elem [a = $a]) $x) Nil)'/3,
...
'with--with block in isElem-962'(V0, V1, V2, V3, V4, V5, V6) -> case V4 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V7) -> {'Idris.Prelude.Types.Yes', {'Idris.Data.List.Elem.There', V7}} end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V8) -> {'Idris.Prelude.Types.No', fun (V9) -> ('un--neitherHereNorThere'('erased', 'erased', 'erased', 'erased', V6, V8, V9)) end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--isElem-926'(V0, V1, V2, V3, V4, V5) -> case V4 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V6) -> case V6 of {'Idris.Builtin.Refl'} -> (fun () -> {'Idris.Prelude.Types.Yes', {'Idris.Data.List.Elem.Here'}} end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V7) -> ('with--with block in isElem-962'('erased', V1, V2, V5, ('un--isElem'('erased', V1, V2, V5)), V3, V7)) end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--decEq-759'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V6 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V8) -> case V8 of {'Idris.Builtin.Refl'} -> (fun () -> {'Idris.Prelude.Types.Yes', {'Idris.Builtin.Refl'}} end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V9) -> {'Idris.Prelude.Types.No', fun (V10) -> (V9(('un--thereInjective'('erased', 'erased', 'erased', 'erased', 'erased', 'erased', V10)))) end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--indexElem-1124'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.DPair.MkDPair', E0, E1} -> (fun (V5, V6) -> {'Idris.Builtin.DPair.MkDPair', V5, {'Idris.Data.List.Elem.There', V6}} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--uninhabited_Uninhabited_(|((=== Here) (There $e)),((~=~ Here) (There $e))|)'(V0, V1, V2, V3, V4) -> ('erlang':'throw'("No clauses")).
'dn--un--uninhabited_Uninhabited_(|((=== (There $e)) Here),((~=~ (There $e)) Here)|)'(V0, V1, V2, V3, V4) -> ('erlang':'throw'("No clauses")).
'dn--un--uninhabited_Uninhabited_(((Elem [a = $a]) $x) Nil)'(V0, V1, V2) -> ('erlang':'throw'("No clauses")).
'dn--un--decEq_DecEq_((Elem $x) $xs)'(V0, V1, V2, V3, V4) -> case V3 of {'Idris.Data.List.Elem.Here'} -> (fun () -> case V4 of {'Idris.Data.List.Elem.Here'} -> (fun () -> {'Idris.Prelude.Types.Yes', {'Idris.Builtin.Refl'}} end()); {'Idris.Data.List.Elem.There', E0} -> (fun (V5) -> {'Idris.Prelude.Types.No', fun (V6) -> ('Idris.Idris2.Prelude.Uninhabited':'un--absurd'('erased', 'erased', fun (V7) -> ('dn--un--uninhabited_Uninhabited_(|((=== Here) (There $e)),((~=~ Here) (There $e))|)'('erased', 'erased', 'erased', 'erased', V7)) end, V6)) end} end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end()); {'Idris.Data.List.Elem.There', E1} -> (fun (V8) -> case V4 of {'Idris.Data.List.Elem.Here'} -> (fun () -> {'Idris.Prelude.Types.No', fun (V9) -> ('Idris.Idris2.Prelude.Uninhabited':'un--absurd'('erased', 'erased', fun (V10) -> ('dn--un--uninhabited_Uninhabited_(|((=== (There $e)) Here),((~=~ (There $e)) Here)|)'('erased', 'erased', 'erased', 'erased', V10)) end, V9)) end} end()); {'Idris.Data.List.Elem.There', E2} -> (fun (V11) -> ('with--decEq-759'('erased', 'erased', 'erased', 'erased', V8, V11, ('dn--un--decEq_DecEq_((Elem $x) $xs)'('erased', 'erased', 'erased', V8, V11)), 'erased')) end(E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--__Impl_Uninhabited_(|((=== Here) (There $e)),((~=~ Here) (There $e))|)'(V0, V1, V2, V3, V4) -> ('dn--un--uninhabited_Uninhabited_(|((=== Here) (There $e)),((~=~ Here) (There $e))|)'('erased', 'erased', 'erased', 'erased', V4)).
'dn--un--__Impl_Uninhabited_(|((=== (There $e)) Here),((~=~ (There $e)) Here)|)'(V0, V1, V2, V3, V4) -> ('dn--un--uninhabited_Uninhabited_(|((=== (There $e)) Here),((~=~ (There $e)) Here)|)'('erased', 'erased', 'erased', 'erased', V4)).
'dn--un--__Impl_Uninhabited_(((Elem [a = $a]) $x) Nil)'(V0, V1, V2) -> ('dn--un--uninhabited_Uninhabited_(((Elem [a = $a]) $x) Nil)'('erased', 'erased', V2)).
'dn--un--__Impl_DecEq_((Elem $x) $xs)'(V0, V1, V2, V3, V4) -> ('dn--un--decEq_DecEq_((Elem $x) $xs)'('erased', 'erased', 'erased', V3, V4)).
